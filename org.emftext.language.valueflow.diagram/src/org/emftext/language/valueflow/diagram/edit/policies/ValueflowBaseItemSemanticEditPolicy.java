...
public class ValueflowBaseItemSemanticEditPolicy extends SemanticEditPolicy {
		...
		if (elementType != null) {
			if (semanticCommand != null) {
				...
				completedRequest.setParameter(
						ValueflowBaseEditHelper.EDIT_POLICY_COMMAND, command);
			}
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateStateNextState_3001(State source,
				State target) {
			if (source != null) {
			...
			return canExistStateNextState_3001(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateGiveStateGiveTo_3002(GiveState source,
				TakeState target) {
			if (source != null) {
			...
			return canExistGiveStateGiveTo_3002(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistStateNextState_3001(State source,
				State target) {
		 ...
		 * @generated
		 */
		public static boolean canExistGiveStateGiveTo_3002(GiveState source,
				TakeState target) {
