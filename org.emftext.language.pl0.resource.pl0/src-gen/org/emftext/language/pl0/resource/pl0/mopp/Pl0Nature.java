...
public class Pl0Nature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.emftext.language.pl0.resource.pl0.nature";
	
	private org.eclipse.core.resources.IProject project;
	
	// the IDs of all builders, IDs of additional builders can be added here
	public final static String[] BUILDER_IDS = {org.emftext.language.pl0.resource.pl0.mopp.Pl0BuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.emftext.language.pl0.resource.pl0.mopp.Pl0BuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
