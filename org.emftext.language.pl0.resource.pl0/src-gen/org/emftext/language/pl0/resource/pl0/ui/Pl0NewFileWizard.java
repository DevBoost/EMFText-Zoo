...
public class Pl0NewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.emftext.language.pl0.resource.pl0.ui.Pl0NewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public Pl0NewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.emftext.language.pl0.resource.pl0.ui.Pl0NewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.emftext.language.pl0.resource.pl0.mopp.Pl0Plugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.emftext.language.pl0.resource.pl0.mopp.Pl0Plugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.emftext.language.pl0.resource.pl0.mopp.Pl0MetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public java.lang.String getFileExtension() {
		return new org.emftext.language.pl0.resource.pl0.mopp.Pl0MetaInformation().getSyntaxName();
	}
