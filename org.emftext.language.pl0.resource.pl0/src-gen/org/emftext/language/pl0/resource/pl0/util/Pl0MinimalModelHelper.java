...
// models.
//
public class Pl0MinimalModelHelper {
	
	private final static org.emftext.language.pl0.resource.pl0.util.Pl0EClassUtil eClassUtil = new org.emftext.language.pl0.resource.pl0.util.Pl0EClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + org.emftext.language.pl0.resource.pl0.util.Pl0StringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = org.emftext.language.pl0.resource.pl0.util.Pl0ListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if(attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + org.emftext.language.pl0.resource.pl0.util.Pl0StringUtil.capitalize(attribute.getName());
					}
					java.lang.Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = org.emftext.language.pl0.resource.pl0.util.Pl0ListUtil.castListUnchecked(value);
