...
// @since 3.2
///
public class Pl0BrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.pl0.resource.pl0.ui.Pl0DocBrowserInformationControlInput fInput;
	...
	public Pl0BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	...
	public Pl0BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	...
	// @since 3.4
	///
	public Pl0BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.pl0.resource.pl0.ui.Pl0DocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.pl0.resource.pl0.ui.Pl0DocBrowserInformationControlInput) input;
		...
		org.emftext.language.pl0.resource.pl0.ui.Pl0HTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.pl0.resource.pl0.ui.Pl0HTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	...
	///
	public org.emftext.language.pl0.resource.pl0.ui.Pl0DocBrowserInformationControlInput getInput() {
		return fInput;
	}
