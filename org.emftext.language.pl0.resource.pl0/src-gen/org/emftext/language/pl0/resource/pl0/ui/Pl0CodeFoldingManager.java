...
public class Pl0CodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.pl0.resource.pl0.IPl0BackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.pl0.resource.pl0.ui.Pl0Editor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.pl0.resource.pl0.ui.Pl0Editor) {
				org.emftext.language.pl0.resource.pl0.ui.Pl0Editor editor = (org.emftext.language.pl0.resource.pl0.ui.Pl0Editor) workbenchPart;
	...
	protected org.emftext.language.pl0.resource.pl0.ui.Pl0Editor editor;
	...
	public Pl0CodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.pl0.resource.pl0.ui.Pl0Editor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.pl0.resource.pl0.ui.Pl0Editor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.pl0.resource.pl0.mopp.Pl0Plugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.pl0.resource.pl0.IPl0TextResource textResource = (org.emftext.language.pl0.resource.pl0.IPl0TextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
