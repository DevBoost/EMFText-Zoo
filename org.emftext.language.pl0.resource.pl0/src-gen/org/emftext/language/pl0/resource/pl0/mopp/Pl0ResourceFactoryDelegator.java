...
public class Pl0ResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	...
	public Pl0ResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (org.eclipse.core.runtime.Platform.isRunning()) {
			...
			org.eclipse.core.runtime.IConfigurationElement configurationElements[] = extensionRegistry.getConfigurationElementsFor(org.emftext.language.pl0.resource.pl0.mopp.Pl0Plugin.EP_ADDITIONAL_EXTENSION_PARSER_ID);
		...
		if (factories.get("") == null) {
			factories.put("", new org.emftext.language.pl0.resource.pl0.mopp.Pl0ResourceFactory());
		}
	}
