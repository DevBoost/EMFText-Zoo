...
//
public class Pl0TextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private org.emftext.language.pl0.resource.pl0.IPl0HoverTextProvider hoverTextProvider;
	// The style sheet (css).
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.pl0.resource.pl0.ui.Pl0BrowserInformationControl infoControl;
		...
		//            target element
		public OpenDeclarationAction(org.emftext.language.pl0.resource.pl0.ui.Pl0BrowserInformationControl infoControl) {
		...
		public void run() {
			org.emftext.language.pl0.resource.pl0.ui.Pl0DocBrowserInformationControlInput infoInput = (org.emftext.language.pl0.resource.pl0.ui.Pl0DocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.pl0.resource.pl0.ui.Pl0Hyperlink hyperlink = new org.emftext.language.pl0.resource.pl0.ui.Pl0Hyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.pl0.resource.pl0.ui.Pl0BrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.pl0.resource.pl0.ui.Pl0BrowserInformationControl iControl = new org.emftext.language.pl0.resource.pl0.ui.Pl0BrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.pl0.resource.pl0.ui.Pl0DocBrowserInformationControlInput) {
							org.emftext.language.pl0.resource.pl0.ui.Pl0DocBrowserInformationControlInput input = (org.emftext.language.pl0.resource.pl0.ui.Pl0DocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.pl0.resource.pl0.ui.Pl0BrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.pl0.resource.pl0.ui.Pl0BrowserInformationControl iControl = new org.emftext.language.pl0.resource.pl0.ui.Pl0BrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	// element.
	public Pl0TextHover(org.emftext.language.pl0.resource.pl0.ui.Pl0Editor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.emftext.language.pl0.resource.pl0.mopp.Pl0MetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.emftext.language.pl0.resource.pl0.ui.Pl0DocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.emftext.language.pl0.resource.pl0.ui.Pl0DocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.emftext.language.pl0.resource.pl0.IPl0TextResource textResource = editor.getResource();
	...
	private org.emftext.language.pl0.resource.pl0.ui.Pl0DocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.pl0.resource.pl0.ui.Pl0DocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.pl0.resource.pl0.ui.Pl0HTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			org.emftext.language.pl0.resource.pl0.ui.Pl0HTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.pl0.resource.pl0.ui.Pl0HTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.pl0.resource.pl0.ui.Pl0TextHover.getStyleSheet());
			org.emftext.language.pl0.resource.pl0.ui.Pl0HTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.pl0.resource.pl0.ui.Pl0DocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.language.pl0.resource.pl0.ui.Pl0HTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.pl0.resource.pl0.mopp.Pl0Plugin.PLUGIN_ID);
