...
// hovers, is a proxy.
public class Pl0HyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	...
	public Pl0HyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (org.emftext.language.pl0.resource.pl0.IPl0TextResource) resource;
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlink[] detectHyperlinks(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion region, boolean canShowMultipleHyperlinks) {
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.emftext.language.pl0.resource.pl0.ui.Pl0Hyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
