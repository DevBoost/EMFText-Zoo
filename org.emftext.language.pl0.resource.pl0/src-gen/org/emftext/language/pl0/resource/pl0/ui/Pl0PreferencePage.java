...
//
public class Pl0PreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.emftext.language.pl0.resource.pl0.mopp.Pl0Plugin.getDefault().getPreferenceStore());
		setDescription(" Pl0 Text Editor Preferences");
	}
