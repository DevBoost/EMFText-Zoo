...
public class Pl0NewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	...
	//
	// @param pageName
	public Pl0NewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new pl0 file");
