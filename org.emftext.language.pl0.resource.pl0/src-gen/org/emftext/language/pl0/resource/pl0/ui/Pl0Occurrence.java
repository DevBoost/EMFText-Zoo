...
public class Pl0Occurrence {
	...
	private org.emftext.language.pl0.resource.pl0.ui.Pl0TokenScanner tokenScanner;
	...
	private org.emftext.language.pl0.resource.pl0.IPl0TextResource textResource;
	...
	//
	public Pl0Occurrence(org.emftext.language.pl0.resource.pl0.IPl0TextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.emftext.language.pl0.resource.pl0.ui.Pl0TokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.emftext.language.pl0.resource.pl0.mopp.Pl0MetaInformation().getTokenNames();
	...
	public void handleOccurrenceHighlighting(org.emftext.language.pl0.resource.pl0.ui.Pl0BracketSet bracketSet) {
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addPosition(document, org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.DEFINTION.toString());
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if ((isNull && elementsAtDefinition.contains(occEO)) || !isNull && definitionElement.equals(occEO)) {
						addPosition(document, org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.PROXY.toString());
					}
				}
			}
			token = tokenScanner.nextToken();
