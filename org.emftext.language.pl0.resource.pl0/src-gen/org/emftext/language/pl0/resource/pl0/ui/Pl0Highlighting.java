...
public class Pl0Highlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.emftext.language.pl0.resource.pl0.ui.Pl0PositionHelper positionHelper = new org.emftext.language.pl0.resource.pl0.ui.Pl0PositionHelper();
	private boolean isHighlightBrackets = true;
	private boolean isHighlightOccurrences = true;
	private org.emftext.language.pl0.resource.pl0.ui.Pl0TokenScanner scanner;
	...
	private org.emftext.language.pl0.resource.pl0.ui.Pl0Occurrence occurrence;
	private org.emftext.language.pl0.resource.pl0.ui.Pl0BracketSet bracketSet;
	...
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.language.pl0.resource.pl0.IPl0BackgroundParsingListener {
	...
	public Pl0Highlighting(org.emftext.language.pl0.resource.pl0.IPl0TextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.language.pl0.resource.pl0.ui.Pl0ColorManager colorManager, org.emftext.language.pl0.resource.pl0.ui.Pl0Editor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.language.pl0.resource.pl0.mopp.Pl0Plugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.language.pl0.resource.pl0.ui.Pl0TokenScanner(colorManager);
		occurrence = new org.emftext.language.pl0.resource.pl0.ui.Pl0Occurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.language.pl0.resource.pl0.ui.Pl0BracketSet(sourceviewer, "pl0");
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.pl0.resource.pl0.ui.Pl0PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		isHighlightOccurrences = preferenceStore.getBoolean(org.emftext.language.pl0.resource.pl0.ui.Pl0PreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		definitionColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.pl0.resource.pl0.ui.Pl0PreferenceConstants.EDITOR_DEFINITION_COLOR));
		proxyColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.pl0.resource.pl0.ui.Pl0PreferenceConstants.EDITOR_PROXY_COLOR));
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.pl0.resource.pl0.ui.Pl0PreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.pl0.resource.pl0.ui.Pl0Editor editor) {
	...
	private void setHighlighting() {
		...
		if (occurrence.isPositionsChanged()) {
			...
			org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.DEFINTION.toString());
			setCategoryHighlighting(document,
			org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.PROXY.toString());
		}
		setCategoryHighlighting(document, org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.BRACKET.toString());
	}
	...
	private void setCategoryHighlighting(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.PROXY.toString())) {
		...
		for (org.eclipse.jface.text.Position position : positions) {
			...
			if (tmpPosition != null) {
				if (category.equals(org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.DEFINTION.toString())) {
				...
				if (category.equals(org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.BRACKET.toString())) {
					styleRange = getStyleRangeAtPosition(tmpPosition);
	...
	private void removeHighlighting() {
		org.eclipse.jface.text.IDocument document = projectionViewer.getDocument();
		removeHighlightingCategory(document, org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.BRACKET.toString());
		if (occurrence.isToRemoveHighlighting()) {
			removeHighlightingCategory(document, org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.DEFINTION.toString());
			removeHighlightingCategory(document, org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.PROXY.toString());
		}
	}
	
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, category);
		boolean isOccurrence = (category.equals(org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.DEFINTION.toString()) || category.equals(org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.PROXY.toString()));
		if (category.equals(org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.pl0.resource.pl0.ui.Pl0EObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty()) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof org.emftext.language.pl0.resource.pl0.IPl0TextResource) {
					...
					org.emftext.language.pl0.resource.pl0.IPl0LocationMap locationMap = textResource.getLocationMap();
