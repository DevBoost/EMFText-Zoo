...
//
// A text editor for 'pl0' models.
//
public class Pl0Editor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	
	private org.emftext.language.pl0.resource.pl0.ui.Pl0Highlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.pl0.resource.pl0.ui.Pl0CodeFoldingManager codeFoldingManager;
	private org.emftext.language.pl0.resource.pl0.ui.Pl0BackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.pl0.resource.pl0.ui.Pl0BackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.pl0.resource.pl0.IPl0BackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.pl0.resource.pl0.IPl0BackgroundParsingListener>();
	private org.emftext.language.pl0.resource.pl0.ui.Pl0ColorManager colorManager = new org.emftext.language.pl0.resource.pl0.ui.Pl0ColorManager();
	private org.emftext.language.pl0.resource.pl0.ui.Pl0OutlinePage outlinePage;
	...
	private org.emftext.language.pl0.resource.pl0.ui.Pl0PropertySheetPage propertySheetPage;
	...
	public Pl0Editor() {
		...
		setSourceViewerConfiguration(new org.emftext.language.pl0.resource.pl0.ui.Pl0EditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements org.emftext.language.pl0.resource.pl0.IPl0BackgroundParsingListener {
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), Pl0Editor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.pl0.resource.pl0.IPl0TextResource currentResource = getResource();
				...
				org.emftext.language.pl0.resource.pl0.mopp.Pl0Plugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.pl0.resource.pl0.ui.Pl0Highlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.pl0.resource.pl0.ui.Pl0CodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.pl0.resource.pl0.mopp.Pl0Nature.activate(inputFile.getProject());
		...
		org.emftext.language.pl0.resource.pl0.IPl0TextResource loadedResource = (org.emftext.language.pl0.resource.pl0.IPl0TextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.pl0.resource.pl0.IPl0TextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.pl0.resource.pl0.IPl0TextResource) {
					setResource((org.emftext.language.pl0.resource.pl0.IPl0TextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but
					// some other EMF resource
					org.emftext.language.pl0.resource.pl0.mopp.Pl0Plugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the Pl0Editor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				org.emftext.language.pl0.resource.pl0.mopp.Pl0Plugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.language.pl0.resource.pl0.IPl0TextResource resource) {
		assert resource != null;
	...
	private java.lang.Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.pl0.resource.pl0.ui.Pl0OutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.pl0.resource.pl0.ui.Pl0PropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.pl0.resource.pl0.IPl0TextResource textResource = (org.emftext.language.pl0.resource.pl0.IPl0TextResource) element.eResource();
			...
			org.emftext.language.pl0.resource.pl0.IPl0TextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.pl0.resource.pl0.IPl0TextToken token = lexer.getNextToken();
			...
			org.emftext.language.pl0.resource.pl0.mopp.Pl0Plugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.emftext.language.pl0.resource.pl0.IPl0BackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.pl0.resource.pl0.IPl0BackgroundParsingListener listener : bgParsingListeners) {
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						org.emftext.language.pl0.resource.pl0.ui.Pl0MarkerHelper.unmark(resourceToRefresh);
						org.emftext.language.pl0.resource.pl0.ui.Pl0MarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						org.emftext.language.pl0.resource.pl0.mopp.Pl0Plugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
