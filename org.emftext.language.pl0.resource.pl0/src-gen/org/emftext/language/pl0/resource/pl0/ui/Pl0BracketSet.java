...
public class Pl0BracketSet {
	...
	private java.util.ArrayList<org.emftext.language.pl0.resource.pl0.IPl0BracketPair> bracketPairs;
	...
	private class BracketPair implements org.emftext.language.pl0.resource.pl0.IPl0BracketPair {
	...
	private class ClosingListener implements org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.pl0.resource.pl0.IPl0BracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	...
	public Pl0BracketSet(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String extension) {
		languageID = extension;
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.pl0.resource.pl0.IPl0BracketPair>();
	...
	public org.emftext.language.pl0.resource.pl0.IPl0BracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.pl0.resource.pl0.IPl0BracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.pl0.resource.pl0.IPl0BracketPair getBracketPair(int index) {
		try {
	...
	public boolean setClosingEnabledInside(org.emftext.language.pl0.resource.pl0.IPl0BracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.pl0.resource.pl0.ui.Pl0PreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	public org.emftext.language.pl0.resource.pl0.IPl0BracketPair remove(String opening, String closing) {
		for (org.emftext.language.pl0.resource.pl0.IPl0BracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.pl0.resource.pl0.IPl0BracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.pl0.resource.pl0.ui.Pl0PositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
