...
public class Pl0Hyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	...
	public Pl0Hyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.emftext.language.pl0.resource.pl0.ui.Pl0Editor) {
					org.emftext.language.pl0.resource.pl0.ui.Pl0Editor emftEditor = (org.emftext.language.pl0.resource.pl0.ui.Pl0Editor) editorPart;
