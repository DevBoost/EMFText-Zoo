 ...
 */
public class AbnfTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private org.emftext.language.abnf.resource.abnf.IAbnfHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.abnf.resource.abnf.ui.AbnfBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.abnf.resource.abnf.ui.AbnfBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.abnf.resource.abnf.ui.AbnfDocBrowserInformationControlInput infoInput = (org.emftext.language.abnf.resource.abnf.ui.AbnfDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.abnf.resource.abnf.ui.AbnfHyperlink hyperlink = new org.emftext.language.abnf.resource.abnf.ui.AbnfHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.abnf.resource.abnf.ui.AbnfBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.abnf.resource.abnf.ui.AbnfBrowserInformationControl iControl = new org.emftext.language.abnf.resource.abnf.ui.AbnfBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.abnf.resource.abnf.ui.AbnfDocBrowserInformationControlInput) {
							org.emftext.language.abnf.resource.abnf.ui.AbnfDocBrowserInformationControlInput input = (org.emftext.language.abnf.resource.abnf.ui.AbnfDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.abnf.resource.abnf.ui.AbnfBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.abnf.resource.abnf.ui.AbnfBrowserInformationControl iControl = new org.emftext.language.abnf.resource.abnf.ui.AbnfBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public AbnfTextHover(org.emftext.language.abnf.resource.abnf.ui.AbnfEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.emftext.language.abnf.resource.abnf.ui.AbnfUIMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.emftext.language.abnf.resource.abnf.ui.AbnfDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.emftext.language.abnf.resource.abnf.ui.AbnfDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.emftext.language.abnf.resource.abnf.IAbnfTextResource textResource = editor.getResource();
	 ...
	 */
	private org.emftext.language.abnf.resource.abnf.ui.AbnfDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.abnf.resource.abnf.ui.AbnfDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.abnf.resource.abnf.ui.AbnfHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			org.emftext.language.abnf.resource.abnf.ui.AbnfHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.abnf.resource.abnf.ui.AbnfHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.abnf.resource.abnf.ui.AbnfTextHover.getStyleSheet());
			org.emftext.language.abnf.resource.abnf.ui.AbnfHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.abnf.resource.abnf.ui.AbnfDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.language.abnf.resource.abnf.ui.AbnfHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.abnf.resource.abnf.ui.AbnfUIPlugin.PLUGIN_ID);
