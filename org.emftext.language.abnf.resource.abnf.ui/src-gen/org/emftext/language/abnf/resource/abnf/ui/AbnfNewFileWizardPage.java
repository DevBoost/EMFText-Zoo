 ...
 */
public class AbnfNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public AbnfNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new abnf file");
