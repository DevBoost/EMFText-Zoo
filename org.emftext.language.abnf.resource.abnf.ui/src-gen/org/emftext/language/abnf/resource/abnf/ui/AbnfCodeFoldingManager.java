 ...
 */
public class AbnfCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.abnf.resource.abnf.IAbnfBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.abnf.resource.abnf.ui.AbnfEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.abnf.resource.abnf.ui.AbnfEditor) {
				org.emftext.language.abnf.resource.abnf.ui.AbnfEditor editor = (org.emftext.language.abnf.resource.abnf.ui.AbnfEditor) workbenchPart;
	...
	protected org.emftext.language.abnf.resource.abnf.ui.AbnfEditor editor;
	 ...
	 */
	public AbnfCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.abnf.resource.abnf.ui.AbnfEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.abnf.resource.abnf.ui.AbnfEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.abnf.resource.abnf.ui.AbnfUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.abnf.resource.abnf.IAbnfTextResource textResource = (org.emftext.language.abnf.resource.abnf.IAbnfTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
