...
/**
 * A text editor for 'abnf' models.
 */
public class AbnfEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	
	private org.emftext.language.abnf.resource.abnf.ui.AbnfHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.abnf.resource.abnf.ui.AbnfCodeFoldingManager codeFoldingManager;
	private org.emftext.language.abnf.resource.abnf.ui.AbnfBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.abnf.resource.abnf.ui.AbnfBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.abnf.resource.abnf.IAbnfBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.abnf.resource.abnf.IAbnfBackgroundParsingListener>();
	private org.emftext.language.abnf.resource.abnf.ui.AbnfColorManager colorManager = new org.emftext.language.abnf.resource.abnf.ui.AbnfColorManager();
	private org.emftext.language.abnf.resource.abnf.ui.AbnfOutlinePage outlinePage;
	private org.emftext.language.abnf.resource.abnf.IAbnfTextResource resource;
	private org.eclipse.core.resources.IResourceChangeListener resourceChangeListener = new ModelResourceChangeListener();
	private org.emftext.language.abnf.resource.abnf.ui.AbnfPropertySheetPage propertySheetPage;
	...
	public AbnfEditor() {
		...
		setSourceViewerConfiguration(new org.emftext.language.abnf.resource.abnf.ui.AbnfEditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements org.emftext.language.abnf.resource.abnf.IAbnfBackgroundParsingListener {
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), AbnfEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.abnf.resource.abnf.IAbnfTextResource currentResource = getResource();
				...
				org.emftext.language.abnf.resource.abnf.ui.AbnfUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.language.abnf.resource.abnf.EditorContext");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.abnf.resource.abnf.ui.AbnfHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.abnf.resource.abnf.ui.AbnfCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.abnf.resource.abnf.mopp.AbnfNature.activate(inputFile.getProject());
		...
		org.emftext.language.abnf.resource.abnf.IAbnfTextResource loadedResource = (org.emftext.language.abnf.resource.abnf.IAbnfTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.abnf.resource.abnf.IAbnfTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.abnf.resource.abnf.IAbnfTextResource) {
					setResource((org.emftext.language.abnf.resource.abnf.IAbnfTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.emftext.language.abnf.resource.abnf.ui.AbnfUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the AbnfEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				org.emftext.language.abnf.resource.abnf.ui.AbnfUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	public org.emftext.language.abnf.resource.abnf.IAbnfTextResource getResource() {
		assert resource != null;
		return resource;
	}
	
	private void setResource(org.emftext.language.abnf.resource.abnf.IAbnfTextResource resource) {
		assert resource != null;
	...
	private java.lang.Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.abnf.resource.abnf.ui.AbnfOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.abnf.resource.abnf.ui.AbnfPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.abnf.resource.abnf.IAbnfTextResource textResource = (org.emftext.language.abnf.resource.abnf.IAbnfTextResource) element.eResource();
			org.emftext.language.abnf.resource.abnf.IAbnfLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.emftext.language.abnf.resource.abnf.IAbnfTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.abnf.resource.abnf.IAbnfTextToken token = lexer.getNextToken();
			...
			org.emftext.language.abnf.resource.abnf.ui.AbnfUIPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.emftext.language.abnf.resource.abnf.IAbnfBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.abnf.resource.abnf.IAbnfBackgroundParsingListener listener : bgParsingListeners) {
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						org.emftext.language.abnf.resource.abnf.ui.AbnfMarkerHelper.unmark(resourceToRefresh);
						org.emftext.language.abnf.resource.abnf.ui.AbnfMarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						org.emftext.language.abnf.resource.abnf.ui.AbnfUIPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
