 ...
 */
public class AbnfPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.emftext.language.abnf.resource.abnf.ui.AbnfUIPlugin.getDefault().getPreferenceStore());
		setDescription(" Abnf Text Editor Preferences");
	}
