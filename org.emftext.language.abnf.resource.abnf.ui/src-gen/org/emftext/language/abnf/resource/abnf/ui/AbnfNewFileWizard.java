...
public class AbnfNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.emftext.language.abnf.resource.abnf.ui.AbnfNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public AbnfNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.emftext.language.abnf.resource.abnf.ui.AbnfNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.emftext.language.abnf.resource.abnf.ui.AbnfUIPlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.emftext.language.abnf.resource.abnf.ui.AbnfUIPlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.emftext.language.abnf.resource.abnf.mopp.AbnfMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public java.lang.String getFileExtension() {
		return new org.emftext.language.abnf.resource.abnf.mopp.AbnfMetaInformation().getSyntaxName();
	}
	
	public org.emftext.language.abnf.resource.abnf.IAbnfMetaInformation getMetaInformation() {
		return new org.emftext.language.abnf.resource.abnf.mopp.AbnfMetaInformation();
	}
