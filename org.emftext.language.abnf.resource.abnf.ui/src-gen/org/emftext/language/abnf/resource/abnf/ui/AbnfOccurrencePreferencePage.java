 ...
 * </ul>
 */
public class AbnfOccurrencePreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private void initializeValues() {
		boolean enable = getPreferenceStore().getBoolean(org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		enableCheckbox.setSelection(enable);
		
		defColorButton.setEnabled(enable);
		org.eclipse.swt.graphics.RGB rgb = org.eclipse.jface.preference.PreferenceConverter.getColor(getPreferenceStore(), org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_DEFINITION_COLOR);
		defColorSelector.setColorValue(rgb);
		
		useColorButton.setEnabled(enable);
		rgb = org.eclipse.jface.preference.PreferenceConverter.getColor(getPreferenceStore(), org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_PROXY_COLOR);
	...
	protected void performDefaults() {
		boolean enable = getPreferenceStore().getDefaultBoolean(org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		enableCheckbox.setSelection(enable);
		defColorButton.setEnabled(enable);
		useColorButton.setEnabled(enable);
		defColorSelector.setColorValue(org.eclipse.jface.preference.PreferenceConverter.getDefaultColor(getPreferenceStore(), org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_DEFINITION_COLOR));
		useColorSelector.setColorValue(org.eclipse.jface.preference.PreferenceConverter.getDefaultColor(getPreferenceStore(), org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_PROXY_COLOR));
	}
	...
	private void updateActiveEditor() {
		getPreferenceStore().setValue(org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX, enableCheckbox.getSelection());
		org.eclipse.jface.preference.PreferenceConverter.setValue(getPreferenceStore(), org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_DEFINITION_COLOR, defColorSelector.getColorValue());
		org.eclipse.jface.preference.PreferenceConverter.setValue(getPreferenceStore(), org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_PROXY_COLOR, useColorSelector.getColorValue());
