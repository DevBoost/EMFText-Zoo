 ...
 */
public class AbnfSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.abnf.resource.abnf.ui.AbnfSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.abnf.resource.abnf.ui.AbnfSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.abnf.resource.abnf.ui.AbnfSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.abnf.resource.abnf.ui.AbnfSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.abnf.resource.abnf.ui.AbnfSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.abnf.resource.abnf.ui.AbnfSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.abnf.resource.abnf.ui.AbnfSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.abnf.resource.abnf.ui.AbnfSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.abnf.resource.abnf.ui.AbnfSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.abnf.resource.abnf.ui.AbnfSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.abnf.resource.abnf.ui.AbnfSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.abnf.resource.abnf.ui.AbnfSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.abnf.resource.abnf.ui.AbnfPixelConverter pixelConverter = new org.emftext.language.abnf.resource.abnf.ui.AbnfPixelConverter(composite);
	...
	public AbnfSyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.abnf.resource.abnf.IAbnfMetaInformation syntaxPlugin = new org.emftext.language.abnf.resource.abnf.mopp.AbnfMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.abnf.resource.abnf.ui.AbnfEditor) {
			org.emftext.language.abnf.resource.abnf.ui.AbnfEditor emfTextEditor = (org.emftext.language.abnf.resource.abnf.ui.AbnfEditor) editor;
