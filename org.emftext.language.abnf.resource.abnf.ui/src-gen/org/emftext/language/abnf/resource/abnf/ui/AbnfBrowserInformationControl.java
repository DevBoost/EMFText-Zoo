 ...
 * @since 3.2
 */
public class AbnfBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.abnf.resource.abnf.ui.AbnfDocBrowserInformationControlInput fInput;
	 ...
	 */
	public AbnfBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public AbnfBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public AbnfBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.abnf.resource.abnf.ui.AbnfDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.abnf.resource.abnf.ui.AbnfDocBrowserInformationControlInput) input;
		...
		org.emftext.language.abnf.resource.abnf.ui.AbnfHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.abnf.resource.abnf.ui.AbnfHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.language.abnf.resource.abnf.ui.AbnfDocBrowserInformationControlInput getInput() {
		return fInput;
	}
