 ...
 * contains
 * <code>org.emftext.language.abnf.resource.abnf.IAbnfTextDiagnostic</code>s it
 * uses the more precise information of this extended diagnostic type.
 */
public class AbnfMarkerHelper {
	
	public static final String MARKER_TYPE = org.emftext.language.abnf.resource.abnf.ui.AbnfUIPlugin.PLUGIN_ID + ".problem";
	...
	private static void createMarkersFromDiagnostics(org.eclipse.emf.ecore.resource.Resource resource, org.eclipse.core.resources.IFile file, java.util.List<org.eclipse.emf.ecore.resource.Resource.Diagnostic> diagnostics, int markerSeverity) throws org.eclipse.core.runtime.CoreException {
		...
		for (org.eclipse.emf.ecore.resource.Resource.Diagnostic diagnostic : diagnostics) {
			try {
				...
				if (diagnostic instanceof org.emftext.language.abnf.resource.abnf.IAbnfTextDiagnostic) {
					org.emftext.language.abnf.resource.abnf.IAbnfTextDiagnostic textDiagnostic = (org.emftext.language.abnf.resource.abnf.IAbnfTextDiagnostic) diagnostic;
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource) throws org.eclipse.core.runtime.CoreException {
		org.eclipse.core.resources.IFile file = (org.eclipse.core.resources.IFile) org.eclipse.core.resources.ResourcesPlugin.getWorkspace().getRoot().findMember(resource.getURI().toPlatformString(true));
		if (file != null) {
			file.deleteMarkers(org.emftext.language.abnf.resource.abnf.ui.AbnfMarkerHelper.MARKER_TYPE, false, org.eclipse.core.resources.IResource.DEPTH_ZERO);
		}
	}
}
