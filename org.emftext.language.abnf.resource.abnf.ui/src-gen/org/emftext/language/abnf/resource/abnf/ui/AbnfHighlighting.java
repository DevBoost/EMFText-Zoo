 ...
 */
public class AbnfHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.emftext.language.abnf.resource.abnf.ui.AbnfPositionHelper positionHelper = new org.emftext.language.abnf.resource.abnf.ui.AbnfPositionHelper();
	private boolean isHighlightBrackets = true;
	private boolean isHighlightOccurrences = true;
	private org.emftext.language.abnf.resource.abnf.ui.AbnfTokenScanner scanner;
	private org.emftext.language.abnf.resource.abnf.ui.AbnfColorManager colorManager;
	...
	private org.emftext.language.abnf.resource.abnf.ui.AbnfOccurrence occurrence;
	private org.emftext.language.abnf.resource.abnf.ui.AbnfBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.language.abnf.resource.abnf.IAbnfBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public AbnfHighlighting(org.emftext.language.abnf.resource.abnf.IAbnfTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.language.abnf.resource.abnf.ui.AbnfColorManager colorManager, org.emftext.language.abnf.resource.abnf.ui.AbnfEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.language.abnf.resource.abnf.ui.AbnfUIPlugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.language.abnf.resource.abnf.ui.AbnfTokenScanner(colorManager);
		occurrence = new org.emftext.language.abnf.resource.abnf.ui.AbnfOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.language.abnf.resource.abnf.ui.AbnfBracketSet(sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		isHighlightOccurrences = preferenceStore.getBoolean(org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		definitionColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_DEFINITION_COLOR));
		proxyColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_PROXY_COLOR));
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.abnf.resource.abnf.ui.AbnfEditor editor) {
	...
	private void setHighlighting() {
		...
		if (occurrence.isPositionsChanged()) {
			...
			org.emftext.language.abnf.resource.abnf.ui.AbnfPositionCategory.DEFINTION.toString());
			setCategoryHighlighting(document,
			org.emftext.language.abnf.resource.abnf.ui.AbnfPositionCategory.PROXY.toString());
		}
		setCategoryHighlighting(document, org.emftext.language.abnf.resource.abnf.ui.AbnfPositionCategory.BRACKET.toString());
	}
	...
	private void setCategoryHighlighting(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.abnf.resource.abnf.ui.AbnfPositionCategory.PROXY.toString())) {
		...
		for (org.eclipse.jface.text.Position position : positions) {
			...
			if (tmpPosition != null) {
				if (category.equals(org.emftext.language.abnf.resource.abnf.ui.AbnfPositionCategory.DEFINTION.toString())) {
				...
				if (category.equals(org.emftext.language.abnf.resource.abnf.ui.AbnfPositionCategory.BRACKET.toString())) {
					styleRange = getStyleRangeAtPosition(tmpPosition);
	...
	private void removeHighlighting() {
		org.eclipse.jface.text.IDocument document = projectionViewer.getDocument();
		removeHighlightingCategory(document, org.emftext.language.abnf.resource.abnf.ui.AbnfPositionCategory.BRACKET.toString());
		if (occurrence.isToRemoveHighlighting()) {
			removeHighlightingCategory(document, org.emftext.language.abnf.resource.abnf.ui.AbnfPositionCategory.DEFINTION.toString());
			removeHighlightingCategory(document, org.emftext.language.abnf.resource.abnf.ui.AbnfPositionCategory.PROXY.toString());
		}
	}
	
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, category);
		boolean isOccurrence = (category.equals(org.emftext.language.abnf.resource.abnf.ui.AbnfPositionCategory.DEFINTION.toString()) || category.equals(org.emftext.language.abnf.resource.abnf.ui.AbnfPositionCategory.PROXY.toString()));
		if (category.equals(org.emftext.language.abnf.resource.abnf.ui.AbnfPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.abnf.resource.abnf.ui.AbnfEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty()) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof org.emftext.language.abnf.resource.abnf.IAbnfTextResource) {
