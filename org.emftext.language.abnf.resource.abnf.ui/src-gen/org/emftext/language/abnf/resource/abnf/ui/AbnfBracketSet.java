...
public class AbnfBracketSet {
	...
	private java.util.ArrayList<org.emftext.language.abnf.resource.abnf.IAbnfBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.language.abnf.resource.abnf.IAbnfBracketPair {
	...
	private class ClosingListener implements org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.abnf.resource.abnf.IAbnfBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public AbnfBracketSet(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.language.abnf.resource.abnf.mopp.AbnfMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.abnf.resource.abnf.IAbnfBracketPair>();
	 ...
	 */
	public org.emftext.language.abnf.resource.abnf.IAbnfBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.abnf.resource.abnf.IAbnfBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.abnf.resource.abnf.IAbnfBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.language.abnf.resource.abnf.IAbnfBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.abnf.resource.abnf.ui.AbnfPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.language.abnf.resource.abnf.IAbnfBracketPair remove(String opening, String closing) {
		for (org.emftext.language.abnf.resource.abnf.IAbnfBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.abnf.resource.abnf.IAbnfBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.abnf.resource.abnf.ui.AbnfPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.abnf.resource.abnf.ui.AbnfPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
