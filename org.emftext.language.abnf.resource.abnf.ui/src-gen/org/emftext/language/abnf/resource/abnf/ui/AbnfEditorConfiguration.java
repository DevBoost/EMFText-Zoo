 ...
 */
public class AbnfEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	
	private org.emftext.language.abnf.resource.abnf.ui.AbnfColorManager colorManager;
	private org.emftext.language.abnf.resource.abnf.ui.AbnfEditor theEditor;
	 ...
	 */
	public AbnfEditorConfiguration(org.emftext.language.abnf.resource.abnf.ui.AbnfEditor editor, org.emftext.language.abnf.resource.abnf.ui.AbnfColorManager colorManager) {
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.emftext.language.abnf.resource.abnf.ui.AbnfCompletionProcessor(theEditor), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.emftext.language.abnf.resource.abnf.ui.AbnfTextHover(theEditor);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.emftext.language.abnf.resource.abnf.ui.AbnfHyperlinkDetector(theEditor.getResource()) };
	}
