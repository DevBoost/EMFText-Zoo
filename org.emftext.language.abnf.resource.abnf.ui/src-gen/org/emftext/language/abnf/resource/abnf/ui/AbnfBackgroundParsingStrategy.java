 ...
 */
public class AbnfBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.language.abnf.resource.abnf.IAbnfTextResource resource, final org.emftext.language.abnf.resource.abnf.ui.AbnfEditor editor) {
		if (resource == null) {
			return;
		}
