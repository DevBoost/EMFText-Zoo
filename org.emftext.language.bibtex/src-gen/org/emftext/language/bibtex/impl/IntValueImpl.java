 ...
 * <ul>
 *   <li>{@link org.emftext.language.bibtex.impl.IntValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntValueImpl extends EObjectImpl implements IntValue {
	...
	protected EClass eStaticClass() {
		return BibtexPackage.Literals.INT_VALUE;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BibtexPackage.INT_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BibtexPackage.INT_VALUE__VALUE:
				return getValue();
		}
