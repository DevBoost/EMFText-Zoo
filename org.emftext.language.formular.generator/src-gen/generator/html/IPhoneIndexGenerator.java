...
public class IPhoneIndexGenerator extends org.emftext.language.formular.resource.formular.custom.AbstractGenerator implements org.emftext.language.formular.resource.formular.custom.IGenerator {
  ...
  protected final String TEXT_2 = NL + NL + "<html>" + NL + "<body style=\"background-color:#222222;\">" + NL + "<table align=\"center\" border=\"0\" style=\"background-image:url(./iphone.png);\">" + NL + "\t<tr height=\"143px\"/><td width=\"28px\"/><td width=\"318px\"/><td width=\"45px\"/></tr>" + NL + "\t<tr height=\"467px\"><td/><td>" + NL + "\t<iframe src=\"./";
  protected final String TEXT_3 = ".html\" width=\"100%\" height=\"100%\">" + NL + "\t</iframe>" + NL + "\t</td><td/></tr>" + NL + "\t<tr height=\"120px\"><td/><td/><td/></tr>" + NL + "</table>" + NL + "</body> " + NL + "</html>";
