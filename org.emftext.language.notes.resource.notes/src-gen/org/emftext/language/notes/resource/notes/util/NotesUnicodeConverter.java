 ...
 * to 4 bytes).
 */
public class NotesUnicodeConverter extends org.emftext.language.notes.resource.notes.mopp.NotesInputStreamProcessor {
	 ...
	 */
	public NotesUnicodeConverter(java.io.InputStream inputStream) {
