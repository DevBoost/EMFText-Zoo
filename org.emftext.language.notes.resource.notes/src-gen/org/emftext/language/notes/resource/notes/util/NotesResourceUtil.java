 ...
 */
public class NotesResourceUtil {
	...
	public static org.emftext.language.notes.resource.notes.mopp.NotesResource getResource(java.io.File file) {
	...
	public static org.emftext.language.notes.resource.notes.mopp.NotesResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.emftext.language.notes.resource.notes.mopp.NotesMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.emftext.language.notes.resource.notes.mopp.NotesResource) resource;
	}
	...
	public static org.eclipse.emf.ecore.resource.Resource getResource(String text) {
		org.emftext.language.notes.resource.notes.mopp.NotesMetaInformation metaInformation = new org.emftext.language.notes.resource.notes.mopp.NotesMetaInformation();
	 ...
	 */
	public static org.emftext.language.notes.NoteDocument getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.emftext.language.notes.NoteDocument getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.emftext.language.notes.NoteDocument) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static org.emftext.language.notes.NoteDocument getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		org.emftext.language.notes.resource.notes.INotesTextResource resource = (org.emftext.language.notes.resource.notes.INotesTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (org.emftext.language.notes.resource.notes.INotesTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		org.emftext.language.notes.resource.notes.INotesTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
