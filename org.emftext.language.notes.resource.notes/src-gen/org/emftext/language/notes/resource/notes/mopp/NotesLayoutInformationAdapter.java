...
/**
 * A NotesLayoutInformationAdapter is used to store layout information that is
 ...
 * NotesLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class NotesLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<org.emftext.language.notes.resource.notes.mopp.NotesLayoutInformation> layoutInformations = new java.util.ArrayList<org.emftext.language.notes.resource.notes.mopp.NotesLayoutInformation>();
	...
	public java.util.List<org.emftext.language.notes.resource.notes.mopp.NotesLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.emftext.language.notes.resource.notes.mopp.NotesLayoutInformation layoutInformation) {
