...
public class NotesNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.emftext.language.notes.resource.notes.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.emftext.language.notes.resource.notes.mopp.NotesBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.emftext.language.notes.resource.notes.mopp.NotesBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
