 ...
 */
public class NotesDefaultTokenResolver implements org.emftext.language.notes.resource.notes.INotesTokenResolver {
	 ...
	 */
	public NotesDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public NotesDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.emftext.language.notes.resource.notes.INotesTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.emftext.language.notes.resource.notes.grammar.NotesGrammarInformationProvider.INSTANCE.getKeywords()) {
