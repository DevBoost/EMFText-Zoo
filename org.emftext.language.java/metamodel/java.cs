...
TOKENS {
	...
	DEFINE HEX_DOUBLE_LITERAL_D $'0'('x'|'X')('0'..'9'|'a'..'f'|'A'..'F')* '.' ('0'..'9'|'a'..'f'|'A'..'F')+ (('p'|'P') ('+'|'-')? ('0'..'9')+ ('d'|'D'))?$;
	DEFINE HEX_DOUBLE_LITERAL $'0'('x'|'X')('0'..'9'|'a'..'f'|'A'..'F')* '.' ('0'..'9'|'a'..'f'|'A'..'F')+ (('p'|'P') ('+'|'-')? ('0'..'9')+)?$;
	...
	DEFINE DECIMAL_DOUBLE_LITERAL_D $('0'..'9')+ '.' ('0'..'9')* (('e'|'E') ('+'|'-')? ('0'..'9')+)? ('d'|'D') | ('.' ('0'..'9')+ (('e'|'E') ('+'|'-')? ('0'..'9')+)?) ('d'|'D') | (('0'..'9')+ (('e'|'E') ('+'|'-')? ('0'..'9')+) ('d'|'D') | ('0'..'9')+ ('d'|'D'))$;
	DEFINE DECIMAL_DOUBLE_LITERAL $('0'..'9')+ '.' ('0'..'9')* (('e'|'E') ('+'|'-')? ('0'..'9')+)? | ('.' ('0'..'9')+ (('e'|'E') ('+'|'-')? ('0'..'9')+)?) | (('0'..'9')+ (('e'|'E') ('+'|'-')? ('0'..'9')+))$;
...
literals.DecimalDoubleLiteral 
	::= value[DECIMAL_DOUBLE_LITERAL] | value[DECIMAL_DOUBLE_LITERAL_D];
...
literals.HexDoubleLiteral 
	::= value[HEX_DOUBLE_LITERAL] | value[HEX_DOUBLE_LITERAL_D];
