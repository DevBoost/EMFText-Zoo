...
//
public class SparqlReferenceResolveResult<ReferenceType> implements org.emftext.runtime.resource.IReferenceResolveResult<ReferenceType> {
	
	private java.util.Collection<org.emftext.runtime.resource.IReferenceMapping<ReferenceType>> mappings;
	private String errorMessage;
	private boolean resolveFuzzy;
	
	public SparqlReferenceResolveResult(boolean resolveFuzzy) {
		super();
	...
	public void addMapping(String identifier, ReferenceType target, String warning) {
		...
		mappings.add(new org.emftext.language.sparql.resource.sparql.SparqlElementMapping<ReferenceType>(identifier, target, warning));
		errorMessage = null;
	}
	...
	public void addMapping(String identifier, org.eclipse.emf.common.util.URI uri, String warning) {
		...
		mappings.add(new org.emftext.language.sparql.resource.sparql.SparqlURIMapping<ReferenceType>(identifier, uri, warning));
	}
}
