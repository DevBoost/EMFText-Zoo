		...
		if (resource != null) {
			...
			:
				...
				(
					...
					c0 = parse_org_emftext_language_sparql_SparqlQueries{ element = c0; }
				)
				EOF				
			;
			
			parse_org_emftext_language_sparql_SparqlQueries			 returns [org.emftext.language.sparql.SparqlQueries element = null]
			@init{
			}
			:
				{
			...
			parse_org_emftext_language_sparql_Prologue			 returns [org.emftext.language.sparql.Prologue element = null]
			@init{
			}
			:
				{
			...
			parse_org_emftext_language_sparql_BaseDecl			 returns [org.emftext.language.sparql.BaseDecl element = null]
			@init{
			}
			:
				{
			...
			parse_org_emftext_language_sparql_PrefixDecl			 returns [org.emftext.language.sparql.PrefixDecl element = null]
			@init{
			}
			:
				{
			...
			parse_org_emftext_language_sparql_IRI_005FREF_005FSTRING			 returns [org.emftext.language.sparql.IRI_REF_STRING element = null]
			@init{
			}
			:
				{
			...
			parse_org_emftext_language_sparql_PNAME_005FNS			 returns [org.emftext.language.sparql.PNAME_NS element = null]
			@init{
			}
			:
				{
			...
			parse_org_emftext_language_sparql_INTEGER			 returns [org.emftext.language.sparql.INTEGER element = null]
			@init{
			}
			:
				{
