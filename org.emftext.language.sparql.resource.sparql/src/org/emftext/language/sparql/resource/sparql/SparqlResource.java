...
public class SparqlResource extends org.emftext.runtime.resource.impl.AbstractTextResource {
	...
	public SparqlResource(org.eclipse.emf.common.util.URI uri) {
		super(uri);
		resetLocationMap();
	}
	...
	protected void doSave(java.io.OutputStream outputStream, java.util.Map<?,?> options) throws java.io.IOException {
		org.emftext.language.sparql.resource.sparql.SparqlPrinter printer = new org.emftext.language.sparql.resource.sparql.SparqlPrinter(outputStream, this);
		org.emftext.runtime.resource.IReferenceResolverSwitch referenceResolverSwitch = getReferenceResolverSwitch();
		referenceResolverSwitch.setOptions(options);
	...
	public org.emftext.runtime.resource.IReferenceResolverSwitch getReferenceResolverSwitch() {
		if (resolverSwitch == null) {
			resolverSwitch = new org.emftext.language.sparql.resource.sparql.SparqlReferenceResolverSwitch();
		}
	...
	protected void resetLocationMap() {
		locationMap = new SparqlLocationMap();
	}
			...
			if (uri != null) {
				...
				if (result == null || result.eIsProxy()) {
					...
					if (errorMessage == null) {
						...
						addProblem(new org.emftext.language.sparql.resource.sparql.SparqlProblem(errorMessage, org.emftext.runtime.resource.EProblemType.ERROR), proxy);
					}
				}
				return result;
			}
	...
	private void attachWarnings(org.emftext.runtime.resource.IReferenceResolveResult<? extends org.eclipse.emf.ecore.EObject> result, org.eclipse.emf.ecore.EObject proxy) {
		...
		if (result.wasResolved()) {
			for (org.emftext.runtime.resource.IReferenceMapping<? extends org.eclipse.emf.ecore.EObject> mapping : result.getMappings()) {
				...
				addProblem(new org.emftext.language.sparql.resource.sparql.SparqlProblem(warningMessage, org.emftext.runtime.resource.EProblemType.ERROR), proxy);
			}
		}
	}
