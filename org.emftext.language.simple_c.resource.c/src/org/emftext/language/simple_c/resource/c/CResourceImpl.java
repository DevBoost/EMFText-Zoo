...
public class CResourceImpl extends TextResourceImpl {
	private EMFTextTreeAnalyser analyser;


	public CResourceImpl(){
		super();
	}

	public CResourceImpl(URI uri){
		super(uri);
	}

	protected void doLoad(InputStream inputStream, Map<?,?> options) throws IOException {
		java.util.Map<Object, Object> loadOptions = addDefaultLoadOptions(options);
		EMFTextParser p = new CParser(new CommonTokenStream(new CLexer(new ANTLRInputStream(inputStream))));
		p.setResource(this);
	...
	protected void doSave(OutputStream outputStream, Map<?,?> options) throws IOException {
		EMFTextPrinter p = new CPrinter(outputStream, this);
	...
	public String[] getTokenNames() {
		return new CParser(null).getTokenNames();
	}
