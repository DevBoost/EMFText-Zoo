...
public class PlBracketSet {
	...
	private java.util.ArrayList<org.emftext.language.prolog.resource.pl.IPlBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.language.prolog.resource.pl.IPlBracketPair {
	 ...
	 */
	private class ClosingListener implements org.emftext.language.prolog.resource.pl.ui.IPlBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.prolog.resource.pl.IPlBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public PlBracketSet(org.emftext.language.prolog.resource.pl.ui.PlEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.language.prolog.resource.pl.mopp.PlMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.prolog.resource.pl.IPlBracketPair>();
	 ...
	 */
	public org.emftext.language.prolog.resource.pl.IPlBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.prolog.resource.pl.IPlBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.prolog.resource.pl.IPlBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.language.prolog.resource.pl.IPlBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.prolog.resource.pl.ui.PlPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.language.prolog.resource.pl.IPlBracketPair remove(String opening, String closing) {
		for (org.emftext.language.prolog.resource.pl.IPlBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.prolog.resource.pl.IPlBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.prolog.resource.pl.ui.PlPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.prolog.resource.pl.ui.PlPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
