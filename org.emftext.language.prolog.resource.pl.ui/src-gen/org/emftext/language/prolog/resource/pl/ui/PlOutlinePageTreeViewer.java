...
public class PlOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public PlOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.emftext.language.prolog.resource.pl.util.PlStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.language.prolog.resource.pl.ui.PlEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.language.prolog.resource.pl.mopp.PlPlugin.logError("Exception while refreshing outline view", e);
		}
	}
