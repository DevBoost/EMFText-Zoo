...
public class PlCodeFoldingManager {
	...
	private class FoldingUpdateListener implements org.emftext.language.prolog.resource.pl.IPlBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.prolog.resource.pl.ui.PlEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.prolog.resource.pl.ui.PlEditor) {
				org.emftext.language.prolog.resource.pl.ui.PlEditor editor = (org.emftext.language.prolog.resource.pl.ui.PlEditor) workbenchPart;
	...
	protected org.emftext.language.prolog.resource.pl.ui.PlEditor editor;
	 ...
	 */
	public PlCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.prolog.resource.pl.ui.PlEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.prolog.resource.pl.ui.PlEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.prolog.resource.pl.ui.PlUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.prolog.resource.pl.IPlTextResource textResource = (org.emftext.language.prolog.resource.pl.IPlTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
