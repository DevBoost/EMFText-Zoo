...
public class PlTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.emftext.language.prolog.resource.pl.IPlHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.prolog.resource.pl.ui.PlBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.prolog.resource.pl.ui.PlBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.prolog.resource.pl.ui.PlDocBrowserInformationControlInput infoInput = (org.emftext.language.prolog.resource.pl.ui.PlDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.prolog.resource.pl.ui.PlHyperlink hyperlink = new org.emftext.language.prolog.resource.pl.ui.PlHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.prolog.resource.pl.ui.PlBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.prolog.resource.pl.ui.PlBrowserInformationControl iControl = new org.emftext.language.prolog.resource.pl.ui.PlBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.prolog.resource.pl.ui.PlDocBrowserInformationControlInput) {
							org.emftext.language.prolog.resource.pl.ui.PlDocBrowserInformationControlInput input = (org.emftext.language.prolog.resource.pl.ui.PlDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.prolog.resource.pl.ui.PlBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.prolog.resource.pl.ui.PlBrowserInformationControl iControl = new org.emftext.language.prolog.resource.pl.ui.PlBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public PlTextHover(org.emftext.language.prolog.resource.pl.IPlResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.language.prolog.resource.pl.ui.PlUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.emftext.language.prolog.resource.pl.ui.PlDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.emftext.language.prolog.resource.pl.ui.PlDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.emftext.language.prolog.resource.pl.ui.PlDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.prolog.resource.pl.ui.PlDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.prolog.resource.pl.ui.PlHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.language.prolog.resource.pl.ui.PlHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.prolog.resource.pl.ui.PlHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.prolog.resource.pl.ui.PlTextHover.getStyleSheet());
			org.emftext.language.prolog.resource.pl.ui.PlHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.prolog.resource.pl.ui.PlDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.language.prolog.resource.pl.ui.PlHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.prolog.resource.pl.ui.PlUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.language.prolog.resource.pl.util.PlStreamUtil.getContent(styleSheetURL.openStream());
