...
public class PlNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	private org.emftext.language.prolog.resource.pl.ui.PlNewFileWizardPage page;
	...
	public void addPages() {
		page = new org.emftext.language.prolog.resource.pl.ui.PlNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.emftext.language.prolog.resource.pl.ui.PlUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.emftext.language.prolog.resource.pl.ui.PlUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.emftext.language.prolog.resource.pl.mopp.PlMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new org.emftext.language.prolog.resource.pl.mopp.PlMetaInformation().getSyntaxName();
	}
