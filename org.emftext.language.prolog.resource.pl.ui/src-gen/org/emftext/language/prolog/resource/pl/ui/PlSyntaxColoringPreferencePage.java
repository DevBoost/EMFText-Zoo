...
public class PlSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public PlSyntaxColoringPreferencePage() {
		...
		org.emftext.language.prolog.resource.pl.mopp.PlMetaInformation metaInformation = new org.emftext.language.prolog.resource.pl.mopp.PlMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.prolog.resource.pl.ui.PlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.prolog.resource.pl.ui.PlSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.prolog.resource.pl.ui.PlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.prolog.resource.pl.ui.PlSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.prolog.resource.pl.ui.PlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.prolog.resource.pl.ui.PlSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.prolog.resource.pl.ui.PlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.prolog.resource.pl.ui.PlSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.prolog.resource.pl.ui.PlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.prolog.resource.pl.ui.PlSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.prolog.resource.pl.ui.PlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.prolog.resource.pl.ui.PlSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.prolog.resource.pl.ui.PlPixelConverter pixelConverter = new org.emftext.language.prolog.resource.pl.ui.PlPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.prolog.resource.pl.ui.PlEditor) {
			org.emftext.language.prolog.resource.pl.ui.PlEditor emfTextEditor = (org.emftext.language.prolog.resource.pl.ui.PlEditor) editor;
