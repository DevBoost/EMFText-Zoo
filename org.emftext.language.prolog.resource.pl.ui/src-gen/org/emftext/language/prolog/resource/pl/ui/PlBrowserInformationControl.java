...
public class PlBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.prolog.resource.pl.ui.PlDocBrowserInformationControlInput fInput;
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.prolog.resource.pl.ui.PlDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.prolog.resource.pl.ui.PlDocBrowserInformationControlInput) input;
		...
		org.emftext.language.prolog.resource.pl.ui.PlHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.prolog.resource.pl.ui.PlHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.language.prolog.resource.pl.ui.PlDocBrowserInformationControlInput getInput() {
		return fInput;
	}
