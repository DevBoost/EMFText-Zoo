...
public class PlOutlinePage extends org.eclipse.ui.part.Page implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.ui.views.contentoutline.IContentOutlinePage {
	...
	public final static String CONTEXT_MENU_ID = "org.emftext.language.prolog.resource.pl.ui.outlinecontext";
	...
	public PlOutlinePage(org.emftext.language.prolog.resource.pl.IPlResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		treeViewer = new org.emftext.language.prolog.resource.pl.ui.PlOutlinePageTreeViewer(parent, org.eclipse.swt.SWT.MULTI | org.eclipse.swt.SWT.H_SCROLL | org.eclipse.swt.SWT.V_SCROLL);
		...
		treeViewer.setComparator(new org.emftext.language.prolog.resource.pl.ui.PlOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.emftext.language.prolog.resource.pl.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		java.util.List<org.eclipse.jface.action.IAction> actions = new org.emftext.language.prolog.resource.pl.ui.PlOutlinePageActionProvider().getActions(treeViewer);
