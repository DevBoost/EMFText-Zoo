...
public class PlHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.emftext.language.prolog.resource.pl.ui.PlPositionHelper positionHelper = new org.emftext.language.prolog.resource.pl.ui.PlPositionHelper();
	...
	private org.emftext.language.prolog.resource.pl.ui.PlTokenScanner scanner;
	...
	private org.emftext.language.prolog.resource.pl.ui.PlEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.emftext.language.prolog.resource.pl.ui.PlOccurrence occurrence;
	private org.emftext.language.prolog.resource.pl.ui.PlBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.language.prolog.resource.pl.IPlBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public PlHighlighting(org.emftext.language.prolog.resource.pl.IPlTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.language.prolog.resource.pl.ui.PlColorManager colorManager, org.emftext.language.prolog.resource.pl.ui.PlEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.language.prolog.resource.pl.ui.PlUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.language.prolog.resource.pl.ui.PlTokenScanner(textResource, colorManager);
		occurrence = new org.emftext.language.prolog.resource.pl.ui.PlOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.language.prolog.resource.pl.ui.PlBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.prolog.resource.pl.ui.PlPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.prolog.resource.pl.ui.PlPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.prolog.resource.pl.ui.PlEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.emftext.language.prolog.resource.pl.ui.PlPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.emftext.language.prolog.resource.pl.ui.PlPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.prolog.resource.pl.ui.PlPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.prolog.resource.pl.ui.PlEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
