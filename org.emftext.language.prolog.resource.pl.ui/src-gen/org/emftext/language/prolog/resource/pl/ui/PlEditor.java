 ...
 */
public class PlEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.emftext.language.prolog.resource.pl.IPlResourceProvider, org.emftext.language.prolog.resource.pl.ui.IPlBracketHandlerProvider, org.emftext.language.prolog.resource.pl.ui.IPlAnnotationModelProvider {
	
	private org.emftext.language.prolog.resource.pl.ui.PlHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.prolog.resource.pl.ui.PlCodeFoldingManager codeFoldingManager;
	private org.emftext.language.prolog.resource.pl.ui.PlBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.prolog.resource.pl.ui.PlBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.prolog.resource.pl.IPlBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.prolog.resource.pl.IPlBackgroundParsingListener>();
	private org.emftext.language.prolog.resource.pl.ui.PlColorManager colorManager = new org.emftext.language.prolog.resource.pl.ui.PlColorManager();
	private org.emftext.language.prolog.resource.pl.ui.PlOutlinePage outlinePage;
	...
	private org.emftext.language.prolog.resource.pl.ui.PlPropertySheetPage propertySheetPage;
	...
	private org.emftext.language.prolog.resource.pl.ui.IPlBracketHandler bracketHandler;
	...
	public PlEditor() {
		super();
		setSourceViewerConfiguration(new org.emftext.language.prolog.resource.pl.ui.PlSourceViewerConfiguration(this, this, this, colorManager));
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.prolog.resource.pl.IPlTextResource currentResource = getResource();
				...
				org.emftext.language.prolog.resource.pl.ui.PlUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.language.prolog.resource.pl.EditorContext");
		setRulerContextMenuId("org.emftext.language.prolog.resource.pl.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.prolog.resource.pl.ui.PlHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.prolog.resource.pl.ui.PlCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.prolog.resource.pl.mopp.PlNature.activate(inputFile.getProject());
		...
		org.emftext.language.prolog.resource.pl.IPlTextResource loadedResource = (org.emftext.language.prolog.resource.pl.IPlTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.prolog.resource.pl.IPlTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.prolog.resource.pl.IPlTextResource) {
					setResource((org.emftext.language.prolog.resource.pl.IPlTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.emftext.language.prolog.resource.pl.ui.PlUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the PlEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.emftext.language.prolog.resource.pl.ui.PlUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.language.prolog.resource.pl.IPlTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.prolog.resource.pl.ui.PlOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.prolog.resource.pl.ui.PlPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.prolog.resource.pl.IPlTextResource textResource = (org.emftext.language.prolog.resource.pl.IPlTextResource) element.eResource();
			...
			org.emftext.language.prolog.resource.pl.IPlTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.prolog.resource.pl.IPlTextToken token = lexer.getNextToken();
			...
			org.emftext.language.prolog.resource.pl.ui.PlUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.emftext.language.prolog.resource.pl.IPlBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.prolog.resource.pl.IPlBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.emftext.language.prolog.resource.pl.ui.IPlBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.emftext.language.prolog.resource.pl.ui.IPlBracketHandler bracketHandler) {
