...
public class PlLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.emftext.language.prolog.resource.pl.mopp.PlMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.emftext.language.prolog.resource.pl.launch.PlLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.emftext.language.prolog.resource.pl.mopp.PlPlugin.logError("Exception while launching selection", e);
		}
	}
