...
public class PlNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.emftext.language.prolog.resource.pl.mopp.PlMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.emftext.language.prolog.resource.pl.ui");
							...
							String natureID = org.emftext.language.prolog.resource.pl.mopp.PlNature.NATURE_ID;
							...
							for (String builderID : org.emftext.language.prolog.resource.pl.mopp.PlNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.emftext.language.prolog.resource.pl.mopp.PlMetaInformation info = new org.emftext.language.prolog.resource.pl.mopp.PlMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.emftext.language.prolog.resource.pl.ui.PlUIPlugin.getDefault().getBundle();
