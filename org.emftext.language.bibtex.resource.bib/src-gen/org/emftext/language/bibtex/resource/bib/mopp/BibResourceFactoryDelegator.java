...
public class BibResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public BibResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (org.eclipse.core.runtime.Platform.isRunning()) {
			...
			org.eclipse.core.runtime.IConfigurationElement configurationElements[] = extensionRegistry.getConfigurationElementsFor(org.emftext.language.bibtex.resource.bib.mopp.BibPlugin.EP_ADDITIONAL_EXTENSION_PARSER_ID);
		...
		if (factories.get("") == null) {
			factories.put("", new org.emftext.language.bibtex.resource.bib.mopp.BibResourceFactory());
		}
	}
