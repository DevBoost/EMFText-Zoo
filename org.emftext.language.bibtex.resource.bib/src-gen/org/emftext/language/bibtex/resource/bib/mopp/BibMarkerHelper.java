 ...
 * contains
 * <code>org.emftext.language.bibtex.resource.bib.IBibTextDiagnostic</code>s it
 * uses the more precise information of this extended diagnostic type.
 */
public class BibMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.emftext.language.bibtex.resource.bib.mopp.BibPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.emftext.language.bibtex.resource.bib.IBibCommand<Object>> commands = new java.util.ArrayList<org.emftext.language.bibtex.resource.bib.IBibCommand<Object>>();
		private final Object jobLock = new Object();
		
		public void addCommand(org.emftext.language.bibtex.resource.bib.IBibCommand<Object> command) {
			...
			new org.eclipse.core.runtime.jobs.Job("updating markers") {
				...
				protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
					synchronized(jobLock) {
						java.util.List<org.emftext.language.bibtex.resource.bib.IBibCommand<Object>> commandsToProcess = new java.util.ArrayList<org.emftext.language.bibtex.resource.bib.IBibCommand<Object>>();
						synchronized(commands) {
							commandsToProcess.addAll(commands);
							commands.clear();
						}
						for (org.emftext.language.bibtex.resource.bib.IBibCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public static void mark(org.eclipse.emf.ecore.resource.Resource resource, final org.emftext.language.bibtex.resource.bib.IBibTextDiagnostic diagnostic) {
	...
	private static void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.emftext.language.bibtex.resource.bib.IBibTextDiagnostic diagnostic) {
		final org.emftext.language.bibtex.resource.bib.IBibProblem problem = diagnostic.getProblem();
		org.emftext.language.bibtex.resource.bib.BibEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.emftext.language.bibtex.resource.bib.IBibCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.emftext.language.bibtex.resource.bib.BibEProblemSeverity.ERROR) {
					...
					org.emftext.language.bibtex.resource.bib.IBibTextDiagnostic textDiagnostic = (org.emftext.language.bibtex.resource.bib.IBibTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.emftext.language.bibtex.resource.bib.mopp.BibResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.emftext.language.bibtex.resource.bib.mopp.BibResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.emftext.language.bibtex.resource.bib.IBibQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.emftext.language.bibtex.resource.bib.util.BibStringUtil.explode(sourceIDs, "|"));
					}
				} catch (org.eclipse.core.runtime.CoreException ce) {
					if (ce.getMessage().matches("Marker.*not found.")) {
						// ignore
					} else {
						org.emftext.language.bibtex.resource.bib.mopp.BibPlugin.logError("Error while creating marks for resource:", ce);
					}
				}
				return true;
			}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.emftext.language.bibtex.resource.bib.BibEProblemType nextType : org.emftext.language.bibtex.resource.bib.BibEProblemType.values()) {
	 ...
	 */
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.language.bibtex.resource.bib.BibEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
			...
			public boolean execute(Object context) {
				try {
					...
					if (ce.getMessage().matches("Marker.*not found.")) {
						...
						org.emftext.language.bibtex.resource.bib.mopp.BibPlugin.logError("Error while removing markers from resource:", ce);
					}
				}
				return true;
			}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.emftext.language.bibtex.resource.bib.BibEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	private static String getMarkerID(org.emftext.language.bibtex.resource.bib.BibEProblemType problemType) {
