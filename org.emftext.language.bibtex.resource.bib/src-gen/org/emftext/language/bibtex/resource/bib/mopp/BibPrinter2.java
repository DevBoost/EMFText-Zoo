...
public class BibPrinter2 implements org.emftext.language.bibtex.resource.bib.IBibTextPrinter {
	...
	protected void doPrint(org.eclipse.emf.ecore.EObject element, java.util.List<org.emftext.language.bibtex.resource.bib.grammar.BibFormattingElement> foundFormattingElements) {
		...
		if (element instanceof org.emftext.language.bibtex.OrganizationField) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_13, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.PublisherField) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_14, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.JournalField) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_15, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.NoteField) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_16, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.EidField) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_17, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.AbstractField) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_18, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.ReviewField) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_19, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.UrlField) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_20, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.YearField) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_21, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.VolumeField) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_22, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.PartField) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_23, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.NumberField) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_24, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.PageField) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_25, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.Page) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_26, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.InProceedingsEntry) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_27, foundFormattingElements);
			return;
		}
		if (element instanceof org.emftext.language.bibtex.ArticleEntry) {
			printInternal(element, org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.BIB_28, foundFormattingElements);
			return;
		}
