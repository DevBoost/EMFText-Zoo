 ...
 */
public class BibDefaultTokenResolver implements org.emftext.language.bibtex.resource.bib.IBibTokenResolver {
	 ...
	 */
	public BibDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public BibDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.emftext.language.bibtex.resource.bib.IBibTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.emftext.language.bibtex.resource.bib.grammar.BibGrammarInformationProvider.INSTANCE.getKeywords()) {
