...
/**
 * A BibLayoutInformationAdapter is used to store layout information that is found
 ...
 * BibLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class BibLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<org.emftext.language.bibtex.resource.bib.mopp.BibLayoutInformation> layoutInformations = new java.util.ArrayList<org.emftext.language.bibtex.resource.bib.mopp.BibLayoutInformation>();
	...
	public java.util.List<org.emftext.language.bibtex.resource.bib.mopp.BibLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.emftext.language.bibtex.resource.bib.mopp.BibLayoutInformation layoutInformation) {
