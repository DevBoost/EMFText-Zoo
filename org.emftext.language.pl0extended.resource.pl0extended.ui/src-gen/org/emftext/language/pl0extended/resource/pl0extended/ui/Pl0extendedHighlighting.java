 ...
 */
public class Pl0extendedHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionHelper positionHelper = new org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionHelper();
	private boolean isHighlightBrackets = true;
	private boolean isHighlightOccurrences = true;
	private org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedTokenScanner scanner;
	...
	private org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedOccurrence occurrence;
	private org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public Pl0extendedHighlighting(org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedColorManager colorManager, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedUIPlugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedTokenScanner(colorManager);
		occurrence = new org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedBracketSet(sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		isHighlightOccurrences = preferenceStore.getBoolean(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		definitionColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_DEFINITION_COLOR));
		proxyColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_PROXY_COLOR));
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor editor) {
	...
	private void setHighlighting() {
		...
		if (occurrence.isPositionsChanged()) {
			...
			org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.DEFINTION.toString());
			setCategoryHighlighting(document,
			org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.PROXY.toString());
		}
		setCategoryHighlighting(document, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.BRACKET.toString());
	}
	...
	private void setCategoryHighlighting(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.PROXY.toString())) {
		...
		for (org.eclipse.jface.text.Position position : positions) {
			...
			if (tmpPosition != null) {
				if (category.equals(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.DEFINTION.toString())) {
				...
				if (category.equals(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.BRACKET.toString())) {
					styleRange = getStyleRangeAtPosition(tmpPosition);
	...
	private void removeHighlighting() {
		org.eclipse.jface.text.IDocument document = projectionViewer.getDocument();
		removeHighlightingCategory(document, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.BRACKET.toString());
		if (occurrence.isToRemoveHighlighting()) {
			removeHighlightingCategory(document, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.DEFINTION.toString());
			removeHighlightingCategory(document, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.PROXY.toString());
		}
	}
	
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, category);
		boolean isOccurrence = (category.equals(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.DEFINTION.toString()) || category.equals(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.PROXY.toString()));
		if (category.equals(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty()) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedTextResource) {
