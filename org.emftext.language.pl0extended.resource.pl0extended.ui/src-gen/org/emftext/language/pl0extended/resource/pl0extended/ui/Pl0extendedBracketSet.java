 ...
 */
public class Pl0extendedBracketSet {
	...
	private java.util.ArrayList<org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBracketPair {
	...
	private class ClosingListener implements org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public Pl0extendedBracketSet(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.language.pl0extended.resource.pl0extended.mopp.Pl0extendedMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBracketPair>();
	 ...
	 */
	public org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBracketPair remove(String opening, String closing) {
		for (org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
