 ...
 */
public class Pl0extendedHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public Pl0extendedHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor) {
					org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor emftEditor = (org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor) editorPart;
