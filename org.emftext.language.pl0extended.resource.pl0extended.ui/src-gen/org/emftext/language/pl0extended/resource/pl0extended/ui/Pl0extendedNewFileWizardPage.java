 ...
 */
public class Pl0extendedNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public Pl0extendedNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new pl0extended file");
