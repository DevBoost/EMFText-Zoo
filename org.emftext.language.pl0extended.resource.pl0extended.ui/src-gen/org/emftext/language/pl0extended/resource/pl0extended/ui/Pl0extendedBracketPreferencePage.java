 ...
 * </ul>
 */
public class Pl0extendedBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new org.emftext.language.pl0extended.resource.pl0extended.mopp.Pl0extendedMetaInformation().getSyntaxName();
	
	private org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public Pl0extendedBracketPreferencePage() {
		super();
		
		org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedMetaInformation metaInformation = new org.emftext.language.pl0extended.resource.pl0extended.mopp.Pl0extendedMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedUIPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedBracketSet(null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(		org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(		language + org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor) {
			((org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor) editor).invalidateTextRepresentation();
		}
	}
