 ...
 */
public class Pl0extendedUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.pl0extended.resource.pl0extended.ui";
	...
	private static Pl0extendedUIPlugin plugin;
	
	public Pl0extendedUIPlugin() {
		super();
	}
	...
	public static Pl0extendedUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, Pl0extendedUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, Pl0extendedUIPlugin.PLUGIN_ID, message);
		}
		final Pl0extendedUIPlugin pluginInstance = Pl0extendedUIPlugin.getDefault();
