...
public class Pl0extendedNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public Pl0extendedNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedUIPlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedUIPlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.emftext.language.pl0extended.resource.pl0extended.mopp.Pl0extendedMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public java.lang.String getFileExtension() {
		return new org.emftext.language.pl0extended.resource.pl0extended.mopp.Pl0extendedMetaInformation().getSyntaxName();
	}
	
	public org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedMetaInformation getMetaInformation() {
		return new org.emftext.language.pl0extended.resource.pl0extended.mopp.Pl0extendedMetaInformation();
	}
