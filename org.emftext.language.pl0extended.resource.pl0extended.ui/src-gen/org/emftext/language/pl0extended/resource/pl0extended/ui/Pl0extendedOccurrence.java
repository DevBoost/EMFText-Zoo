 ...
 */
public class Pl0extendedOccurrence {
	...
	private org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedTokenScanner tokenScanner;
	 ...
	 */
	public Pl0extendedOccurrence(org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.emftext.language.pl0extended.resource.pl0extended.mopp.Pl0extendedMetaInformation().getTokenNames();
	 ...
	 */
	public void handleOccurrenceHighlighting(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedBracketSet bracketSet) {
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addPosition(document, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.DEFINTION.toString());
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if ((isNull && elementsAtDefinition.contains(occEO)) || !isNull && definitionElement.equals(occEO)) {
						addPosition(document, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPositionCategory.PROXY.toString());
					}
				}
			}
			token = tokenScanner.nextToken();
