 ...
 * olInput</code>.
 */
public class Pl0extendedDocBrowserInformationControlInput {
	
	private final Pl0extendedDocBrowserInformationControlInput fPrevious;
	private Pl0extendedDocBrowserInformationControlInput fNext;
	 ...
	 */
	public Pl0extendedDocBrowserInformationControlInput(Pl0extendedDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public Pl0extendedDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public Pl0extendedDocBrowserInformationControlInput getNext() {
		return fNext;
	}
