 ...
 */
public class Pl0extendedTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedDocBrowserInformationControlInput infoInput = (org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedHyperlink hyperlink = new org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedBrowserInformationControl iControl = new org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedDocBrowserInformationControlInput) {
							org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedDocBrowserInformationControlInput input = (org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedBrowserInformationControl iControl = new org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public Pl0extendedTextHover(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedUIMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedTextResource textResource = editor.getResource();
	 ...
	 */
	private org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedTextHover.getStyleSheet());
			org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedUIPlugin.PLUGIN_ID);
