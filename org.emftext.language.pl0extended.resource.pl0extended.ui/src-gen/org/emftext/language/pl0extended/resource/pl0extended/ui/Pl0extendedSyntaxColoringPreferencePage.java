 ...
 */
public class Pl0extendedSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPixelConverter pixelConverter = new org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedPixelConverter(composite);
	...
	public Pl0extendedSyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedMetaInformation syntaxPlugin = new org.emftext.language.pl0extended.resource.pl0extended.mopp.Pl0extendedMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor) {
			org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor emfTextEditor = (org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor) editor;
