 ...
 */
public class Pl0extendedCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor) {
				org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor editor = (org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor) workbenchPart;
	...
	protected org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor editor;
	 ...
	 */
	public Pl0extendedCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.pl0extended.resource.pl0extended.ui.Pl0extendedUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedTextResource textResource = (org.emftext.language.pl0extended.resource.pl0extended.IPl0extendedTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
