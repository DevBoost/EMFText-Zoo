...
public class StateNextStateReferenceResolver extends org.emftext.runtime.resource.impl.AbstractReferenceResolver<org.emftext.language.valueflow.State, org.emftext.language.valueflow.State> {
	...
	private ValueflowDefaultResolverDelegate<org.emftext.language.valueflow.State, org.emftext.language.valueflow.State> delegate = new ValueflowDefaultResolverDelegate<org.emftext.language.valueflow.State, org.emftext.language.valueflow.State>();
