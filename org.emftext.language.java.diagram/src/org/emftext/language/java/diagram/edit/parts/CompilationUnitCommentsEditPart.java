 ...
 * @generated
 */
public class CompilationUnitCommentsEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public CompilationUnitCommentsEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new JavaParserProvider.HintAdapter(
					JavaElementTypes.CompilationUnit_2001, getParserElement(),
					parserHint);
