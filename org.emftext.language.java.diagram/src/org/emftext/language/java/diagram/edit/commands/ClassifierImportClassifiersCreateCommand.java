 ...
 * @generated
 */
public class ClassifierImportClassifiersCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ClassifierImportClassifiersCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof ClassifierImport) {
			return false;
		}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getClassifiers().add(getTarget());
		}
	 ...
	 * @generated
	 */
	protected ClassifierImport getSource() {
		return (ClassifierImport) source;
	}
