...
import org.emftext.language.java.diagram.edit.policies.Annotation2ItemSemanticEditPolicy;
import org.emftext.language.java.diagram.part.JavaVisualIDRegistry;

/**
 * @generated
 */
public class Annotation2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Annotation2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Annotation2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AnnotationName2EditPart) {
			((AnnotationName2EditPart) childEditPart)
	 ...
	 * @generated
	 */
	public class AnnotationFigure extends RoundedRectangle {
