...
import org.emftext.language.java.diagram.edit.policies.BlockItemSemanticEditPolicy;
...
public class BlockEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		BlockFigure figure = new BlockFigure();
	...
	public class BlockFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureBlockLabelFigure;
		...
		private void createContents() {
			...
			fFigureBlockLabelFigure = new WrappingLabel();
			fFigureBlockLabelFigure.setText("Block");

			this.add(fFigureBlockLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureBlockLabelFigure() {
			return fFigureBlockLabelFigure;
		}
