...
import org.emftext.language.java.diagram.edit.policies.Interface2ItemSemanticEditPolicy;
...
public class Interface2EditPart extends ShapeNodeEditPart {
	...
	public class InterfaceFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureInterfaceLabelFigure.setMaximumSize(new Dimension(
