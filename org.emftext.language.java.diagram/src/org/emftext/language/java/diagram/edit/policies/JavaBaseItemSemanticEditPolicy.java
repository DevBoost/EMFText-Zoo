 ...
 * @generated
 */
public class JavaBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(JavaVisualIDRegistry
		...
		if (elementType != null) {
			if (semanticCommand != null) {
				...
				completedRequest.setParameter(
						JavaBaseEditHelper.EDIT_POLICY_COMMAND, command);
			}
