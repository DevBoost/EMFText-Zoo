...
import org.emftext.language.java.diagram.edit.policies.Enumeration2ItemSemanticEditPolicy;
...
public class Enumeration2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Enumeration2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EnumerationName2EditPart) {
			((EnumerationName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureEnumerationLabelFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class EnumerationFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureEnumerationLabelFigure.setMaximumSize(new Dimension(
