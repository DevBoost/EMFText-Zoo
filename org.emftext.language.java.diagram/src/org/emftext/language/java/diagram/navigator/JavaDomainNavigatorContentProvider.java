 ...
 * @generated
 */
public class JavaDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public JavaDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof JavaDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((JavaDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new JavaDomainNavigatorItem((EObject) objects[i],
