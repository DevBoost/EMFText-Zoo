 ...
 * @generated
 */
public class JavaElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public JavaElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.JavaElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "java".equals(fileExtension); //$NON-NLS-1$
	}
	...
	private class ModelElementsTreeContentProvider implements
		...
		private AdapterFactoryContentProvider myAdapterFctoryContentProvier = new AdapterFactoryContentProvider(
				JavaDiagramEditorPlugin.getInstance()
