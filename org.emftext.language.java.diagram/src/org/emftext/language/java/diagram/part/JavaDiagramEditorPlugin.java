 ...
 * @generated
 */
public class JavaDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "org.emftext.language.java.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static JavaDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	private JavaDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	public JavaDiagramEditorPlugin() {
	}
	 ...
	 * @generated
	 */
	public static JavaDiagramEditorPlugin getInstance() {
		return instance;
	}
	 ...
	 * @generated
	 */
	public JavaDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new JavaDocumentProvider();
		}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, JavaDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, JavaDiagramEditorPlugin.ID,
