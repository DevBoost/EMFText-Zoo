 ...
 * @generated
 */
public class JavaCreateShortcutAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		JavaElementChooserDialog elementChooser = new JavaElementChooserDialog(
				myShell, view);
		...
		command = command.compose(new JavaCreateShortcutDecorationsCommand(
