...
public class ClassifierImportClassifierReferenceResolver implements org.emftext.language.java.sqljava.resource.sqljava.ISqljavaReferenceResolver<org.emftext.language.java.imports.ClassifierImport, org.emftext.language.java.classifiers.ConcreteClassifier> {
	...
	public void resolve(java.lang.String identifier, org.emftext.language.java.imports.ClassifierImport container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.emftext.language.java.sqljava.resource.sqljava.ISqljavaReferenceResolveResult<org.emftext.language.java.classifiers.ConcreteClassifier> result) {
		delegate.resolve(identifier, container, reference, position, resolveFuzzy, new IJavaReferenceResolveResult<org.emftext.language.java.classifiers.ConcreteClassifier>() {
			...
			public java.util.Collection<IJavaReferenceMapping<org.emftext.language.java.classifiers.ConcreteClassifier>> getMappings() {
