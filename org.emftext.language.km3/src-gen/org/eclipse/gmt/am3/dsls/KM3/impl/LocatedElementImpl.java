 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.am3.dsls.KM3.impl.LocatedElementImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.eclipse.gmt.am3.dsls.KM3.impl.LocatedElementImpl#getCommentsBefore <em>Comments Before</em>}</li>
 *   <li>{@link org.eclipse.gmt.am3.dsls.KM3.impl.LocatedElementImpl#getCommentsAfter <em>Comments After</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class LocatedElementImpl extends EObjectImpl implements LocatedElement {
	...
	public EList<String> getCommentsBefore() {
		if (commentsBefore == null) {
			commentsBefore = new EDataTypeEList<String>(String.class, this, KM3Package.LOCATED_ELEMENT__COMMENTS_BEFORE);
		}
	...
	public EList<String> getCommentsAfter() {
		if (commentsAfter == null) {
			commentsAfter = new EDataTypeEList<String>(String.class, this, KM3Package.LOCATED_ELEMENT__COMMENTS_AFTER);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KM3Package.LOCATED_ELEMENT__LOCATION:
				return getLocation();
			case KM3Package.LOCATED_ELEMENT__COMMENTS_BEFORE:
				return getCommentsBefore();
			case KM3Package.LOCATED_ELEMENT__COMMENTS_AFTER:
