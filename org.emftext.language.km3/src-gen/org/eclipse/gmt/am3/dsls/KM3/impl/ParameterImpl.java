 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.am3.dsls.KM3.impl.ParameterImpl#getOwner <em>Owner</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterImpl extends TypedElementImpl implements Parameter {
	...
	public Operation getOwner() {
		if (eContainerFeatureID != KM3Package.PARAMETER__OWNER) return null;
	...
	public NotificationChain basicSetOwner(Operation newOwner, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwner, KM3Package.PARAMETER__OWNER, msgs);
		return msgs;
	}
	...
	public void setOwner(Operation newOwner) {
		if (newOwner != eInternalContainer() || (eContainerFeatureID != KM3Package.PARAMETER__OWNER && newOwner != null)) {
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case KM3Package.PARAMETER__OWNER:
				return eInternalContainer().eInverseRemove(this, KM3Package.OPERATION__PARAMETERS, Operation.class, msgs);
		}
