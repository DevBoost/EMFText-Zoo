...
import org.eclipse.gmt.am3.dsls.PrimitiveTypes.*;
...
public class PrimitiveTypesFactoryImpl extends EFactoryImpl implements PrimitiveTypesFactory {
	...
	public static PrimitiveTypesFactory init() {
		try {
			PrimitiveTypesFactory thePrimitiveTypesFactory = (PrimitiveTypesFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/gmt/2005/PrimitiveTypes"); 
