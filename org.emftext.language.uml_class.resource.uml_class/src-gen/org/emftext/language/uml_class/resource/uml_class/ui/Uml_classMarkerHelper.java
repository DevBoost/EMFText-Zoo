...
// If a resource contains <code>org.emftext.language.uml_class.resource.uml_class.IUml_classTextDiagnostic</code>s it uses the more precise information of
// this extended diagnostic type.
public class Uml_classMarkerHelper {
	
	public static final String MARKER_TYPE = org.emftext.language.uml_class.resource.uml_class.mopp.Uml_classPlugin.PLUGIN_ID + ".problem";
	...
	private static void createMarkersFromDiagnostics(org.eclipse.emf.ecore.resource.Resource resource, org.eclipse.core.resources.IFile file, java.util.List<org.eclipse.emf.ecore.resource.Resource.Diagnostic> diagnostics, int markerSeverity) throws org.eclipse.core.runtime.CoreException {
		...
		for (org.eclipse.emf.ecore.resource.Resource.Diagnostic diagnostic : diagnostics) {
			try {
				...
				if (diagnostic instanceof org.emftext.language.uml_class.resource.uml_class.IUml_classTextDiagnostic) {
					org.emftext.language.uml_class.resource.uml_class.IUml_classTextDiagnostic textDiagnostic = (org.emftext.language.uml_class.resource.uml_class.IUml_classTextDiagnostic) diagnostic;
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource) throws org.eclipse.core.runtime.CoreException {
		org.eclipse.core.resources.IFile file = (org.eclipse.core.resources.IFile) org.eclipse.core.resources.ResourcesPlugin.getWorkspace().getRoot().findMember(resource.getURI().toPlatformString(true));
		file.deleteMarkers(org.emftext.language.uml_class.resource.uml_class.ui.Uml_classMarkerHelper.MARKER_TYPE, false, org.eclipse.core.resources.IResource.DEPTH_ZERO);
	}
}
