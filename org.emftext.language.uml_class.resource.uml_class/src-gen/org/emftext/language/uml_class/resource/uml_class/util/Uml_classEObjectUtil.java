...
public class Uml_classEObjectUtil {
	...
	public static java.lang.Object invokeOperation(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EOperation o) {
		...
		try {
			...
			org.emftext.language.uml_class.resource.uml_class.mopp.Uml_classPlugin.logError("java.lang.Exception while matching proxy URI.", e);
