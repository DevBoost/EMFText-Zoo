...
public class Uml_classResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	...
	public Uml_classResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (org.eclipse.core.runtime.Platform.isRunning()) {
			...
			org.eclipse.core.runtime.IConfigurationElement configurationElements[] = extensionRegistry.getConfigurationElementsFor(org.emftext.language.uml_class.resource.uml_class.mopp.Uml_classPlugin.EP_ADDITIONAL_EXTENSION_PARSER_ID);
		...
		if (factories.get("") == null) {
			factories.put("", new org.emftext.language.uml_class.resource.uml_class.mopp.Uml_classResourceFactory());
		}
	}
