...
public class Uml_classDocBrowserInformationControlInput {
	
	private final Uml_classDocBrowserInformationControlInput fPrevious;
	private Uml_classDocBrowserInformationControlInput fNext;
	...
	///
	public Uml_classDocBrowserInformationControlInput(Uml_classDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	...
	public Uml_classDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	...
	public Uml_classDocBrowserInformationControlInput getNext() {
		return fNext;
	}
