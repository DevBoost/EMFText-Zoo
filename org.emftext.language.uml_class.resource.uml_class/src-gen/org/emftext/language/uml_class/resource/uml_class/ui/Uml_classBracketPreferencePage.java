...
// </ul>
//
public class Uml_classBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private org.emftext.language.uml_class.resource.uml_class.ui.Uml_classBracketSet bracketsTmp;
	
	//*
	// Creates a preference page for bracket setting.
	///
	public Uml_classBracketPreferencePage() {
		super();
		
		org.emftext.language.uml_class.resource.uml_class.IUml_classMetaInformation metaInformation = new org.emftext.language.uml_class.resource.uml_class.mopp.Uml_classMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.emftext.language.uml_class.resource.uml_class.mopp.Uml_classPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		if (activeEditor != null) {
			if (activeEditor instanceof org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor) {
				org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor emfTextEditor = (org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor) activeEditor;
				org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource resource = (org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource) emfTextEditor.getResource();
		...
		bracketsTmp.setBrackets(getPreferenceStore().getString(		language + org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					org.emftext.language.uml_class.resource.uml_class.IUml_classBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					org.emftext.language.uml_class.resource.uml_class.IUml_classBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(		org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(		language + org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		
		for (String languageID : languagesCombo.getItems()) {
			getPreferenceStore().setValue(			languageID + org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_BRACKETS_SUFFIX,
		...
		if (editor != null && editor instanceof org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor) {
			((org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor) editor).invalidateTextRepresentation();
		}
	}
}
