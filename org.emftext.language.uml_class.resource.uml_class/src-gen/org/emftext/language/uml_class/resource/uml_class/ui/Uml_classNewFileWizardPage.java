...
public class Uml_classNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	...
	//
	// @param pageName
	public Uml_classNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
