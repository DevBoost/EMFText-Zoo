...
//
public class Uml_classTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private org.emftext.language.uml_class.resource.uml_class.IUml_classHoverTextProvider hoverTextProvider;
	// The style sheet (css).
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.uml_class.resource.uml_class.ui.Uml_classBrowserInformationControl infoControl;
		...
		//            target element
		public OpenDeclarationAction(org.emftext.language.uml_class.resource.uml_class.ui.Uml_classBrowserInformationControl infoControl) {
		...
		public void run() {
			org.emftext.language.uml_class.resource.uml_class.ui.Uml_classDocBrowserInformationControlInput infoInput = (org.emftext.language.uml_class.resource.uml_class.ui.Uml_classDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.uml_class.resource.uml_class.ui.Uml_classHyperlink hyperlink = new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.uml_class.resource.uml_class.ui.Uml_classBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.uml_class.resource.uml_class.ui.Uml_classBrowserInformationControl iControl = new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.uml_class.resource.uml_class.ui.Uml_classDocBrowserInformationControlInput) {
							org.emftext.language.uml_class.resource.uml_class.ui.Uml_classDocBrowserInformationControlInput input = (org.emftext.language.uml_class.resource.uml_class.ui.Uml_classDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.uml_class.resource.uml_class.ui.Uml_classBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.uml_class.resource.uml_class.ui.Uml_classBrowserInformationControl iControl = new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	// element.
	public Uml_classTextHover(org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.emftext.language.uml_class.resource.uml_class.mopp.Uml_classMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.emftext.language.uml_class.resource.uml_class.ui.Uml_classDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.emftext.language.uml_class.resource.uml_class.ui.Uml_classDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource textResource = editor.getResource();
	...
	private org.emftext.language.uml_class.resource.uml_class.ui.Uml_classDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.uml_class.resource.uml_class.ui.Uml_classDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.uml_class.resource.uml_class.ui.Uml_classHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			org.emftext.language.uml_class.resource.uml_class.ui.Uml_classHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.uml_class.resource.uml_class.ui.Uml_classHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.uml_class.resource.uml_class.ui.Uml_classTextHover.getStyleSheet());
			org.emftext.language.uml_class.resource.uml_class.ui.Uml_classHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.language.uml_class.resource.uml_class.ui.Uml_classHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		...
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.uml_class.resource.uml_class.mopp.Uml_classPlugin.PLUGIN_ID);
