...
public class Uml_classPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.uml_class.resource.uml_class";
	...
	private static Uml_classPlugin plugin;
	
	public Uml_classPlugin() {
		super();
	}
	...
	public static Uml_classPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, Uml_classPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, Uml_classPlugin.PLUGIN_ID, message);
		}
		final Uml_classPlugin pluginInstance = Uml_classPlugin.getDefault();
