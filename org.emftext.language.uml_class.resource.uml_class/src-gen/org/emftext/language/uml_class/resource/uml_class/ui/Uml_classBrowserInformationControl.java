...
// @since 3.2
///
public class Uml_classBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.uml_class.resource.uml_class.ui.Uml_classDocBrowserInformationControlInput fInput;
	...
	public Uml_classBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	...
	public Uml_classBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	...
	// @since 3.4
	///
	public Uml_classBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.uml_class.resource.uml_class.ui.Uml_classDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.uml_class.resource.uml_class.ui.Uml_classDocBrowserInformationControlInput) input;
		...
		org.emftext.language.uml_class.resource.uml_class.ui.Uml_classHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.uml_class.resource.uml_class.ui.Uml_classHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	...
	///
	public org.emftext.language.uml_class.resource.uml_class.ui.Uml_classDocBrowserInformationControlInput getInput() {
		return fInput;
	}
