...
public class Uml_classHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	...
	public Uml_classHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor) {
					org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor emftEditor = (org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor) editorPart;
