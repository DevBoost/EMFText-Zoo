...
public class Uml_classCodeFoldingManager {
	...
	protected org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor editor;
	...
	public Uml_classCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor textEditor) {
	...
	private class FoldingUpdateListener implements org.emftext.language.uml_class.resource.uml_class.IUml_classBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor) {
				org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor editor = (org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor) workbenchPart;
	...
	private void addCloseListener(final org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor editor) {
	...
	protected void calculatePositions() {
		org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource textResource = (org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
