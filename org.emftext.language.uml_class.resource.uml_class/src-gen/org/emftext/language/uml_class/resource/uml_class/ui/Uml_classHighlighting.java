...
public class Uml_classHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionHelper positionHelper = new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionHelper();
	private boolean isHighlightBrackets = true;
	private boolean isHighlightOccurrences = true;
	private org.emftext.language.uml_class.resource.uml_class.ui.Uml_classTokenScanner scanner;
	...
	private org.emftext.language.uml_class.resource.uml_class.ui.Uml_classOccurrence occurrence;
	private org.emftext.language.uml_class.resource.uml_class.ui.Uml_classBracketSet bracketSet;
	...
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.language.uml_class.resource.uml_class.IUml_classBackgroundParsingListener {
	...
	public Uml_classHighlighting(org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.language.uml_class.resource.uml_class.ui.Uml_classColorManager colorManager, org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.language.uml_class.resource.uml_class.mopp.Uml_classPlugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classTokenScanner(textResource, colorManager);
		occurrence = new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classBracketSet(sourceviewer, "uml_class");
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		isHighlightOccurrences = preferenceStore.getBoolean(org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		definitionColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_DEFINITION_COLOR));
		proxyColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_PROXY_COLOR));
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditor editor) {
	...
	private void setHighlighting() {
		...
		if (occurrence.isPositionsChanged()) {
			...
			org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionCategory.DEFINTION.toString());
			setCategoryHighlighting(document,
			org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionCategory.PROXY.toString());
		}
		setCategoryHighlighting(document, org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionCategory.BRACKET.toString());
	}
	...
	private void setCategoryHighlighting(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionCategory.PROXY.toString())) {
		...
		for (org.eclipse.jface.text.Position position : positions) {
			...
			if (tmpPosition != null) {
				if (category.equals(org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionCategory.DEFINTION.toString())) {
				...
				if (category.equals(org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionCategory.BRACKET.toString())) {
					styleRange = getStyleRangeAtPosition(tmpPosition);
	...
	private void removeHighlighting() {
		org.eclipse.jface.text.IDocument document = projectionViewer.getDocument();
		removeHighlightingCategory(document, org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionCategory.BRACKET.toString());
		if (occurrence.isToRemoveHighlighting()) {
			removeHighlightingCategory(document, org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionCategory.DEFINTION.toString());
			removeHighlightingCategory(document, org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionCategory.PROXY.toString());
			lastStyleRange = null;
		}
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, category);
		boolean isOccurrence = (category.equals(org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionCategory.DEFINTION.toString()) || category.equals(org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionCategory.PROXY.toString())) && lastStyleRange != null;
		if (category.equals(org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty() && selection instanceof org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEObjectSelection) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource) {
