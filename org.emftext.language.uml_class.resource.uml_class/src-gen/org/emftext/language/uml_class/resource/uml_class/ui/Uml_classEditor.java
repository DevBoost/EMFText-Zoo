...
///
public class Uml_classEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	
	private org.emftext.language.uml_class.resource.uml_class.ui.Uml_classHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.uml_class.resource.uml_class.ui.Uml_classCodeFoldingManager codeFoldingManager;
	private org.emftext.language.uml_class.resource.uml_class.ui.Uml_classBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.uml_class.resource.uml_class.IUml_classBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.uml_class.resource.uml_class.IUml_classBackgroundParsingListener>();
	private org.emftext.language.uml_class.resource.uml_class.ui.Uml_classColorManager colorManager = new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classColorManager();
	private org.emftext.language.uml_class.resource.uml_class.ui.Uml_classOutlinePage emfTextEditorOutlinePage;
	...
	private org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPropertySheetPage propertySheetPage;
	...
	private final class MarkerUpdateListener implements org.emftext.language.uml_class.resource.uml_class.IUml_classBackgroundParsingListener {
		public void parsingCompleted(org.eclipse.emf.ecore.resource.Resource resource) {
			try {
				org.emftext.language.uml_class.resource.uml_class.ui.Uml_classMarkerHelper.unmark(resource);
				org.emftext.language.uml_class.resource.uml_class.ui.Uml_classMarkerHelper.mark(resource);
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, resource, Uml_classEditor.this);
		}
	}
	...
	private final class MarkerAdapter extends org.eclipse.emf.common.notify.impl.AdapterImpl {
		...
		public boolean isAdapterForType(java.lang.Object type) {
			return type == Uml_classEditor.class;
		}
		...
		public void notifyChanged(org.eclipse.emf.common.notify.Notification notification) {
			...
			if (notifier != null && notifier instanceof org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource) {
				org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource resource = (org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource) notifier;
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
				...
				org.emftext.language.uml_class.resource.uml_class.mopp.Uml_classPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public Uml_classEditor() {
		super();
		setDocumentProvider(new org.eclipse.ui.editors.text.FileDocumentProvider());
		setSourceViewerConfiguration(new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classEditorConfiguration(this, colorManager));
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classHighlighting(resource, viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		resource = (org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource) resourceSet.getResource(uri, false);
		if (resource == null) {
			try {
				org.eclipse.emf.ecore.resource.Resource loadedResource = resourceSet.getResource(uri, true);
				if (loadedResource instanceof org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource) {
					setResource(loadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but
					// some other EMF resource
					org.emftext.language.uml_class.resource.uml_class.mopp.Uml_classPlugin.showErrorDialog("No EMFText resource.", "Sorry, no registered EMFText resource can handle this file type.");
				}
			} catch (java.lang.Exception e) {
				org.emftext.language.uml_class.resource.uml_class.mopp.Uml_classPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		}
	}
	...
	protected void setResource(org.eclipse.emf.ecore.resource.Resource loadedResource) throws org.eclipse.core.runtime.CoreException {
		resource = (org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource) loadedResource;
		org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(resource);
		org.emftext.language.uml_class.resource.uml_class.ui.Uml_classMarkerHelper.unmark(resource);
		org.emftext.language.uml_class.resource.uml_class.ui.Uml_classMarkerHelper.mark(resource);
	...
	protected void performSave(boolean overwrite, org.eclipse.core.runtime.IProgressMonitor progressMonitor) {
		...
		try {
			...
			org.emftext.language.uml_class.resource.uml_class.mopp.Uml_classPlugin.logError("java.lang.Exception while updating markers on resource", e);
		}
	...
	protected void setResource(org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource resource) {
		this.resource = resource;
	}
	
	private java.lang.Object getOutlinePage() {
		if (emfTextEditorOutlinePage == null) {
			emfTextEditorOutlinePage = new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPropertySheetPage();
	...
	//
	// @param element
	//            has to be contained in the org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource of this editor.
	///
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource textResource = (org.emftext.language.uml_class.resource.uml_class.IUml_classTextResource) element.eResource();
			...
			org.emftext.language.uml_class.resource.uml_class.IUml_classTextScanner lexer = resource.getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.uml_class.resource.uml_class.IUml_classTextToken token = lexer.getNextToken();
			...
			org.emftext.language.uml_class.resource.uml_class.mopp.Uml_classPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.emftext.language.uml_class.resource.uml_class.IUml_classBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.uml_class.resource.uml_class.IUml_classBackgroundParsingListener listener : bgParsingListeners) {
