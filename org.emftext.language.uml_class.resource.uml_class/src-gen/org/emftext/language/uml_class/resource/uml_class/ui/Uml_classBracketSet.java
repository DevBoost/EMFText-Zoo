...
public class Uml_classBracketSet {
	...
	private java.util.ArrayList<org.emftext.language.uml_class.resource.uml_class.IUml_classBracketPair> bracketPairs;
	...
	private class BracketPair implements org.emftext.language.uml_class.resource.uml_class.IUml_classBracketPair {
	...
	private class ClosingListener implements org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.uml_class.resource.uml_class.IUml_classBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	...
	public Uml_classBracketSet(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String extension) {
		languageID = extension;
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.uml_class.resource.uml_class.IUml_classBracketPair>();
	...
	public org.emftext.language.uml_class.resource.uml_class.IUml_classBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.uml_class.resource.uml_class.IUml_classBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.uml_class.resource.uml_class.IUml_classBracketPair getBracketPair(int index) {
		try {
	...
	public boolean setClosingEnabledInside(org.emftext.language.uml_class.resource.uml_class.IUml_classBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	public org.emftext.language.uml_class.resource.uml_class.IUml_classBracketPair remove(String opening, String closing) {
		for (org.emftext.language.uml_class.resource.uml_class.IUml_classBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.uml_class.resource.uml_class.IUml_classBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.uml_class.resource.uml_class.ui.Uml_classPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
