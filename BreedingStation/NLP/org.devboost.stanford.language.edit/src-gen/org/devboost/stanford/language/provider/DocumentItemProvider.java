...
/**
 * This is the item provider adapter for a {@link org.devboost.stanford.language.Document} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LanguagePackage.Literals.DOCUMENT__SENTENCES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Document.class)) {
			case LanguagePackage.DOCUMENT__SENTENCES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LanguagePackage.Literals.DOCUMENT__SENTENCES,
				 LanguageFactory.eINSTANCE.createSentence()));
	}
