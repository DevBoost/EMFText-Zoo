...
public class LatexGenerator {
  ...
  private String generateLatexForFunction(final Function function, final String prefix) {
      ...
      {
        for(final Function childFunction : validChildren) {
          String _operator_plus_1 = StringExtensions.operator_plus("sub", prefix);
          String _generateLatexForFunction = this.generateLatexForFunction(childFunction, _operator_plus_1);
