...
public class MFeatureTypeReferenceResolver implements IMecoreReferenceResolver<MFeature, MType> {
	...
	public void resolve(String identifier, MFeature container, EReference reference, int position, boolean resolveFuzzy, final IMecoreReferenceResolveResult<MType> result) {
