 ...
 */
public class BibCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.bibtex.resource.bib.IBibBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.bibtex.resource.bib.ui.BibEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.bibtex.resource.bib.ui.BibEditor) {
				org.emftext.language.bibtex.resource.bib.ui.BibEditor editor = (org.emftext.language.bibtex.resource.bib.ui.BibEditor) workbenchPart;
	...
	protected org.emftext.language.bibtex.resource.bib.ui.BibEditor editor;
	 ...
	 */
	public BibCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.bibtex.resource.bib.ui.BibEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.bibtex.resource.bib.ui.BibEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.bibtex.resource.bib.ui.BibUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.bibtex.resource.bib.IBibTextResource textResource = (org.emftext.language.bibtex.resource.bib.IBibTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
