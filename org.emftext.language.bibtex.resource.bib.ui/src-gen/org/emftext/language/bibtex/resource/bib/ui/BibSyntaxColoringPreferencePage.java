 ...
 */
public class BibSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public BibSyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.bibtex.resource.bib.IBibMetaInformation syntaxPlugin = new org.emftext.language.bibtex.resource.bib.mopp.BibMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.bibtex.resource.bib.ui.BibSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.bibtex.resource.bib.ui.BibSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.bibtex.resource.bib.ui.BibSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.bibtex.resource.bib.ui.BibSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.bibtex.resource.bib.ui.BibSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.bibtex.resource.bib.ui.BibSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.bibtex.resource.bib.ui.BibSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.bibtex.resource.bib.ui.BibSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.bibtex.resource.bib.ui.BibSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.bibtex.resource.bib.ui.BibSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.bibtex.resource.bib.ui.BibSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.bibtex.resource.bib.ui.BibSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.bibtex.resource.bib.ui.BibPixelConverter pixelConverter = new org.emftext.language.bibtex.resource.bib.ui.BibPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.bibtex.resource.bib.ui.BibEditor) {
			org.emftext.language.bibtex.resource.bib.ui.BibEditor emfTextEditor = (org.emftext.language.bibtex.resource.bib.ui.BibEditor) editor;
