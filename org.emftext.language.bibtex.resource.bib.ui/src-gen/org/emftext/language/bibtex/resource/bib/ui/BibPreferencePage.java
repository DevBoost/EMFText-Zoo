 ...
 */
public class BibPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.emftext.language.bibtex.resource.bib.ui.BibUIPlugin.getDefault().getPreferenceStore());
		setDescription(" Bib Text Editor Preferences");
	}
