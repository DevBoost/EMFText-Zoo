 ...
 */
public class BibUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.bibtex.resource.bib.ui";
	public static final String EDITOR_ID = "org.emftext.language.bibtex.resource.bib.ui.BibEditor";
	...
	private static BibUIPlugin plugin;
	...
	public static BibUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BibUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BibUIPlugin.PLUGIN_ID, message);
		}
		final BibUIPlugin pluginInstance = BibUIPlugin.getDefault();
