 ...
 */
public class BibNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public BibNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new bib file");
