 ...
 */
public class BibBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.language.bibtex.resource.bib.IBibTextResource resource, final org.emftext.language.bibtex.resource.bib.ui.BibEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.emftext.language.bibtex.resource.bib.IBibTextResource resource, final org.emftext.language.bibtex.resource.bib.ui.BibEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.language.bibtex.resource.bib.IBibTextResource resource, final org.emftext.language.bibtex.resource.bib.ui.BibEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
