...
public class BibBracketSet {
	...
	private java.util.ArrayList<org.emftext.language.bibtex.resource.bib.IBibBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.language.bibtex.resource.bib.IBibBracketPair {
	 ...
	 */
	private class ClosingListener implements org.emftext.language.bibtex.resource.bib.ui.IBibBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.bibtex.resource.bib.IBibBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public BibBracketSet(org.emftext.language.bibtex.resource.bib.ui.BibEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.language.bibtex.resource.bib.mopp.BibMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.bibtex.resource.bib.IBibBracketPair>();
	 ...
	 */
	public org.emftext.language.bibtex.resource.bib.IBibBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.bibtex.resource.bib.IBibBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.bibtex.resource.bib.IBibBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.language.bibtex.resource.bib.IBibBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.bibtex.resource.bib.ui.BibPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.language.bibtex.resource.bib.IBibBracketPair remove(String opening, String closing) {
		for (org.emftext.language.bibtex.resource.bib.IBibBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.bibtex.resource.bib.IBibBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.bibtex.resource.bib.ui.BibPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.bibtex.resource.bib.ui.BibPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
