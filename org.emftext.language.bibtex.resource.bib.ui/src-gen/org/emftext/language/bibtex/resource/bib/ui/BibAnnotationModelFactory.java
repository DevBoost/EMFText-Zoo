...
public class BibAnnotationModelFactory implements org.eclipse.core.filebuffers.IAnnotationModelFactory {
	...
	public org.eclipse.jface.text.source.IAnnotationModel createAnnotationModel(org.eclipse.core.runtime.IPath location) {
		...
		return new org.emftext.language.bibtex.resource.bib.ui.BibAnnotationModel(resource);
	}
