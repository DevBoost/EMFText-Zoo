 ...
 * @since 3.2
 */
public class BibBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput fInput;
	 ...
	 */
	public BibBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public BibBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public BibBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput) input;
		...
		org.emftext.language.bibtex.resource.bib.ui.BibHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.bibtex.resource.bib.ui.BibHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput getInput() {
		return fInput;
	}
