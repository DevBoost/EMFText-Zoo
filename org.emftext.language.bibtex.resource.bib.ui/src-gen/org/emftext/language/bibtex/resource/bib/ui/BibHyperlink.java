 ...
 */
public class BibHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public BibHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.emftext.language.bibtex.resource.bib.ui.BibEditor) {
					org.emftext.language.bibtex.resource.bib.ui.BibEditor emftEditor = (org.emftext.language.bibtex.resource.bib.ui.BibEditor) editorPart;
