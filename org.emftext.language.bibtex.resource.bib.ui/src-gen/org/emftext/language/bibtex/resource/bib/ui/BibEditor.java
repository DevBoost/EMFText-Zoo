...
/**
 * A text editor for 'bib' models.
 */
public class BibEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.emftext.language.bibtex.resource.bib.IBibResourceProvider, org.emftext.language.bibtex.resource.bib.ui.IBibBracketHandlerProvider, org.emftext.language.bibtex.resource.bib.ui.IBibAnnotationModelProvider {
	
	private org.emftext.language.bibtex.resource.bib.ui.BibHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.bibtex.resource.bib.ui.BibCodeFoldingManager codeFoldingManager;
	private org.emftext.language.bibtex.resource.bib.ui.BibBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.bibtex.resource.bib.ui.BibBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.bibtex.resource.bib.IBibBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.bibtex.resource.bib.IBibBackgroundParsingListener>();
	private org.emftext.language.bibtex.resource.bib.ui.BibColorManager colorManager = new org.emftext.language.bibtex.resource.bib.ui.BibColorManager();
	private org.emftext.language.bibtex.resource.bib.ui.BibOutlinePage outlinePage;
	...
	private org.emftext.language.bibtex.resource.bib.ui.BibPropertySheetPage propertySheetPage;
	...
	private org.emftext.language.bibtex.resource.bib.ui.IBibBracketHandler bracketHandler;
	...
	public BibEditor() {
		super();
		setSourceViewerConfiguration(new org.emftext.language.bibtex.resource.bib.ui.BibEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), BibEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.bibtex.resource.bib.IBibTextResource currentResource = getResource();
				...
				org.emftext.language.bibtex.resource.bib.ui.BibUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.language.bibtex.resource.bib.EditorContext");
		setRulerContextMenuId("org.emftext.language.bibtex.resource.bib.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.bibtex.resource.bib.ui.BibHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.bibtex.resource.bib.ui.BibCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.bibtex.resource.bib.mopp.BibNature.activate(inputFile.getProject());
		...
		org.emftext.language.bibtex.resource.bib.IBibTextResource loadedResource = (org.emftext.language.bibtex.resource.bib.IBibTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.bibtex.resource.bib.IBibTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.bibtex.resource.bib.IBibTextResource) {
					setResource((org.emftext.language.bibtex.resource.bib.IBibTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.emftext.language.bibtex.resource.bib.ui.BibUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the BibEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.emftext.language.bibtex.resource.bib.ui.BibUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.language.bibtex.resource.bib.IBibTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.bibtex.resource.bib.ui.BibOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.bibtex.resource.bib.ui.BibPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.bibtex.resource.bib.IBibTextResource textResource = (org.emftext.language.bibtex.resource.bib.IBibTextResource) element.eResource();
			org.emftext.language.bibtex.resource.bib.IBibLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.emftext.language.bibtex.resource.bib.IBibTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.bibtex.resource.bib.IBibTextToken token = lexer.getNextToken();
			...
			org.emftext.language.bibtex.resource.bib.ui.BibUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!BibEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.emftext.language.bibtex.resource.bib.IBibBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.bibtex.resource.bib.IBibBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.emftext.language.bibtex.resource.bib.ui.IBibBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.emftext.language.bibtex.resource.bib.ui.IBibBracketHandler bracketHandler) {
