 ...
 */
public class BibEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	...
	private org.emftext.language.bibtex.resource.bib.ui.BibQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public BibEditorConfiguration(org.emftext.language.bibtex.resource.bib.IBibResourceProvider resourceProvider, org.emftext.language.bibtex.resource.bib.ui.IBibAnnotationModelProvider annotationModelProvider, org.emftext.language.bibtex.resource.bib.ui.IBibBracketHandlerProvider bracketHandlerProvider, org.emftext.language.bibtex.resource.bib.ui.BibColorManager colorManager) {
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.emftext.language.bibtex.resource.bib.ui.BibCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.emftext.language.bibtex.resource.bib.ui.BibTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.emftext.language.bibtex.resource.bib.ui.BibTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.emftext.language.bibtex.resource.bib.ui.BibHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.emftext.language.bibtex.resource.bib.ui.BibQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
