 ...
 */
public class BibImageProvider {
	
	public final static BibImageProvider INSTANCE = new BibImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(org.emftext.language.bibtex.resource.bib.ui.BibUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				org.emftext.language.bibtex.resource.bib.ui.BibUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
