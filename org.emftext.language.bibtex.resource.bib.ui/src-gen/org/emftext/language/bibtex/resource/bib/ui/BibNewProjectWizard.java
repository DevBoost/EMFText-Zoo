 ...
 */
public class BibNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.emftext.language.bibtex.resource.bib.mopp.BibMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.emftext.language.bibtex.resource.bib.ui");
							...
							String natureID = org.emftext.language.bibtex.resource.bib.mopp.BibNature.NATURE_ID;
							...
							for (String builderID : org.emftext.language.bibtex.resource.bib.mopp.BibNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.emftext.language.bibtex.resource.bib.mopp.BibMetaInformation info = new org.emftext.language.bibtex.resource.bib.mopp.BibMetaInformation();
