 ...
 */
public class BibHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.emftext.language.bibtex.resource.bib.ui.BibPositionHelper positionHelper = new org.emftext.language.bibtex.resource.bib.ui.BibPositionHelper();
	private boolean isHighlightBrackets = true;
	private org.emftext.language.bibtex.resource.bib.ui.BibTokenScanner scanner;
	...
	private org.emftext.language.bibtex.resource.bib.ui.BibOccurrence occurrence;
	private org.emftext.language.bibtex.resource.bib.ui.BibBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.language.bibtex.resource.bib.IBibBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public BibHighlighting(org.emftext.language.bibtex.resource.bib.IBibTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.language.bibtex.resource.bib.ui.BibColorManager colorManager, org.emftext.language.bibtex.resource.bib.ui.BibEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.language.bibtex.resource.bib.ui.BibUIPlugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.language.bibtex.resource.bib.ui.BibTokenScanner(textResource, colorManager);
		occurrence = new org.emftext.language.bibtex.resource.bib.ui.BibOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.language.bibtex.resource.bib.ui.BibBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.bibtex.resource.bib.ui.BibPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.bibtex.resource.bib.ui.BibPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.bibtex.resource.bib.ui.BibEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.emftext.language.bibtex.resource.bib.ui.BibPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.emftext.language.bibtex.resource.bib.ui.BibPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.bibtex.resource.bib.ui.BibPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.bibtex.resource.bib.ui.BibEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty()) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof org.emftext.language.bibtex.resource.bib.IBibTextResource) {
