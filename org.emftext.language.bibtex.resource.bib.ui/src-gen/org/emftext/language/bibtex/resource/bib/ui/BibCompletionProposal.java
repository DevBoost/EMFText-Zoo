 ...
 */
public class BibCompletionProposal implements java.lang.Comparable<BibCompletionProposal> {
	...
	public BibCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public BibCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public BibCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof BibCompletionProposal) {
			BibCompletionProposal other = (BibCompletionProposal) object;
	...
	public int compareTo(BibCompletionProposal object) {
		if (object instanceof BibCompletionProposal) {
			BibCompletionProposal other = (BibCompletionProposal) object;
