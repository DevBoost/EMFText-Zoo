 ...
 * olInput</code>.
 */
public class BibDocBrowserInformationControlInput {
	
	private final BibDocBrowserInformationControlInput fPrevious;
	private BibDocBrowserInformationControlInput fNext;
	 ...
	 */
	public BibDocBrowserInformationControlInput(BibDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public BibDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public BibDocBrowserInformationControlInput getNext() {
		return fNext;
	}
