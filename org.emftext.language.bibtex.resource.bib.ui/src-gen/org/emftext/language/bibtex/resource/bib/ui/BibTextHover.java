...
public class BibTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	 ...
	 */
	public BibTextHover(org.emftext.language.bibtex.resource.bib.ui.BibEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.emftext.language.bibtex.resource.bib.ui.BibUIMetaInformation().getHoverTextProvider();
	}
	...
	private org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.emftext.language.bibtex.resource.bib.IBibTextResource textResource = editor.getResource();
	...
	private org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.bibtex.resource.bib.ui.BibHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
		...
		if (buffer.length() > 0) {
			...
			return new org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
