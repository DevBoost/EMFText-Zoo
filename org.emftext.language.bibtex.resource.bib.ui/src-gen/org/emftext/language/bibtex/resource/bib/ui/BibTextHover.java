 ...
 */
public class BibTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.emftext.language.bibtex.resource.bib.IBibHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.bibtex.resource.bib.ui.BibBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.bibtex.resource.bib.ui.BibBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput infoInput = (org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.bibtex.resource.bib.ui.BibHyperlink hyperlink = new org.emftext.language.bibtex.resource.bib.ui.BibHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.bibtex.resource.bib.ui.BibBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.bibtex.resource.bib.ui.BibBrowserInformationControl iControl = new org.emftext.language.bibtex.resource.bib.ui.BibBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput) {
							org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput input = (org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.bibtex.resource.bib.ui.BibBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.bibtex.resource.bib.ui.BibBrowserInformationControl iControl = new org.emftext.language.bibtex.resource.bib.ui.BibBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public BibTextHover(org.emftext.language.bibtex.resource.bib.IBibResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.language.bibtex.resource.bib.ui.BibUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.bibtex.resource.bib.ui.BibHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.language.bibtex.resource.bib.ui.BibHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.bibtex.resource.bib.ui.BibHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.bibtex.resource.bib.ui.BibTextHover.getStyleSheet());
			org.emftext.language.bibtex.resource.bib.ui.BibHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.bibtex.resource.bib.ui.BibDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.language.bibtex.resource.bib.ui.BibHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.bibtex.resource.bib.ui.BibUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.language.bibtex.resource.bib.util.BibStreamUtil.getContent(styleSheetURL.openStream());
