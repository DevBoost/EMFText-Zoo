 ...
 * a specified depth.
 */
public class BibOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public BibOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.emftext.language.bibtex.resource.bib.ui.BibEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.language.bibtex.resource.bib.mopp.BibPlugin.logError("Exception while refreshing outline view", e);
		}
	}
