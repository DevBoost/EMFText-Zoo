...
public class NestedTypePathNameEnumLiteralOrStaticPropertyExpCSTypeOrEnumLiteralOrStaticPropertyReferenceResolver implements org.emftext.language.eocl.resource.eocl.IEoclReferenceResolver<tudresden.ocl20.pivot.language.ocl.NestedTypePathNameEnumLiteralOrStaticPropertyExpCS, tudresden.ocl20.pivot.pivotmodel.NamedElement> {
	
	private tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.NestedTypePathNameEnumLiteralOrStaticPropertyExpCSTypeOrEnumLiteralOrStaticPropertyReferenceResolver delegate = new tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.NestedTypePathNameEnumLiteralOrStaticPropertyExpCSTypeOrEnumLiteralOrStaticPropertyReferenceResolver();
