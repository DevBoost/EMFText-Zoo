...
public class HEDLGenerator {
  ...
  public StringConcatenation generateMainDAOBase(final String packageName, final String className, final EntityModel entityModel) {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private Logger logger = Logger.getLogger(getClass().getName());");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("tx.setTimeout(5);");
    _builder.newLine();
    _builder.append("\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("logger.log(Level.SEVERE, \"TransactionException: \" + te.getMessage());");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("logger.log(Level.SEVERE, \"Exception (\" + e.getClass().getName() + \"): \" + e.getMessage());");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("logger.log(Level.SEVERE, \"HibernateException: \" + he.getMessage());");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("}");
    _builder.newLine();
      ...
      for(final Entity entity_1 : _entities_2) {
        ...
        _builder.newLine();
        {
          for(final Property property_1 : uniqueProperties) {
            ...
            _builder.append(_name_14, "	 ");
            _builder.append(" with the given ");
            String _name_15 = property_1.getName();
            _builder.append(_name_15, "	 ");
            _builder.append(".");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            ...
            _builder.append(_name_17, "	");
            _builder.append("By");
            String _name_18 = property_1.getName();
            ...
            _builder.append(_javaClassname_1, "	");
            _builder.append(" ");
            String _name_19 = property_1.getName();
            _builder.append(_name_19, "	");
            _builder.append(") {");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
              ...
              if ((constraint instanceof UniqueConstraint)) {
                ...
                _builder.append("By");
                {
                  ...
                  for(final Property property_2 : _properties_2) {
                    ...
                    String _firstUpper_1 = StringExtensions.toFirstUpper(_name_25);
                    _builder.append(_firstUpper_1, "	");
                  }
                }
                _builder.append("(");
      ...
      for(final Entity entity_1 : _entities_2) {
        ...
        _builder.newLine();
        {
          for(final Property property_2 : uniqueProperties) {
            _builder.append("\t");
            _builder.append("/** Constructor using the unique property ");
            ...
            _builder.append("DAO.createWith");
        ...
        _builder.newLine();
        {
          for(final Property property_3 : uniqueProperties) {
            ...
            _builder.append(" entity = ");
            String _name_30 = entity_1.getName();
            String _firstLower_8 = StringExtensions.toFirstLower(_name_30);
            _builder.append(_firstLower_8, "		");
            _builder.append("DAO.getBy");
            String _name_31 = property_3.getName();
            String _firstUpper_3 = StringExtensions.toFirstUpper(_name_31);
            _builder.append(_firstUpper_3, "		");
            _builder.append("(session, ");
              ...
              if ((constraint instanceof UniqueConstraint)) {
                ...
                _builder.append("DAO.getBy");
                {
                  ...
                  for(final Property property_6 : _properties_5) {
                    ...
                    String _firstUpper_5 = StringExtensions.toFirstUpper(_name_40);
                ...
                _builder.append("(session, ");
                {
                  ...
                  for(final Property property_7 : _properties_6) {
  ...
  public StringConcatenation generateEntityDAO(final String packageName, final Entity entity) {
    ...
    _builder.newLine();
    {
      for(final Property property_3 : uniqueProperties) {
        ...
        _builder.append(_name_13, "	 ");
        _builder.append(" using the unique property ");
    ...
    _builder.newLine();
    {
      for(final Property property_4 : uniqueProperties) {
        _builder.append("\t");
        _builder.append("/**");
        _builder.newLine();
        _builder.append("\t");
        ...
        String _upperCase_1 = _name_33.toUpperCase();
          ...
          if ((constraint instanceof UniqueConstraint)) {
            ...
            _builder.append(" getBy");
            {
              ...
              for(final Property property_5 : _properties_3) {
                ...
                String _firstUpper_3 = StringExtensions.toFirstUpper(_name_38);
                _builder.append(_firstUpper_3, "	");
              }
            }
            _builder.append("(Session session, ");
            {
              EList<Property> _properties_4 = uniqueConstraint.getProperties();
              for(final Property property_6 : _properties_4) {
  ...
  public StringConcatenation generateEntityBaseClass(final String packageName, final Entity entity) {
    ...
    _builder.newLine();
    {
      ...
      for(final Property property_4 : _properties_3) {
        ...
        _builder.append("\t");
        _builder.append("return ");
        String _name_12 = property_4.getName();
        _builder.append(_name_12, "		");
        _builder.append(";");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        ...
        String _name_13 = property_4.getName();
        ...
        _builder.append("\t");
        _builder.append("this.");
        String _name_14 = property_4.getName();
        _builder.append(_name_14, "		");
        _builder.append(" = newValue;");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
