      ...
      for(final Entity entity_1 : _entities_2) {
        ...
        }
        {
          for(final Property property_3 : toOneProperties) {
            ...
            String _firstLower_6 = StringExtensions.toFirstLower(_name_32);
            _builder.append(_firstLower_6, "		");
            _builder.append("DAO.getBy");
            String _name_33 = property_3.getName();
            String _firstUpper_3 = StringExtensions.toFirstUpper(_name_33);
            _builder.append(_firstUpper_3, "		");
            _builder.append("(session, ");
        ...
        }
        {
          for(final Property property_4 : enumProperties) {
            ...
            _builder.append(_name_35, "	 ");
            _builder.append("s with the given ");
            String _name_36 = property_4.getName();
            _builder.append(_name_36, "	 ");
            _builder.append(".");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            ...
            _builder.append(_name_38, "	");
            _builder.append("sBy");
            String _name_39 = property_4.getName();
            String _firstUpper_4 = StringExtensions.toFirstUpper(_name_39);
            _builder.append(_firstUpper_4, "	");
            _builder.append("(");
            Type _type_3 = property_4.getType();
            String _javaClassname_3 = _type_3.getJavaClassname();
            ...
            String _firstUpper_5 = StringExtensions.toFirstUpper(_name_42);
            _builder.append(_firstUpper_5, "		");
            _builder.append("(session, ");
            String _name_43 = property_4.getName();
            _builder.append(_name_43, "		");
          ...
          for(final Constraint constraint : _constraints) {
            {
              if ((constraint instanceof UniqueConstraint)) {
                ...
                _builder.append("By");
                {
                  EList<Property> _properties_4 = uniqueConstraint.getProperties();
                  for(final Property property_5 : _properties_4) {
                    String _name_47 = property_5.getName();
                    String _firstUpper_6 = StringExtensions.toFirstUpper(_name_47);
                    _builder.append(_firstUpper_6, "	");
                  }
                }
                _builder.append("(");
                {
                  ...
                  for(final Property property_6 : _properties_5) {
                    ...
                    _builder.append(_javaClassname_4, "	");
                    _builder.append(" ");
                    String _name_48 = property_6.getName();
                ...
                _builder.append("DAO.getBy");
                {
                  EList<Property> _properties_7 = uniqueConstraint.getProperties();
                  for(final Property property_7 : _properties_7) {
                    String _name_51 = property_7.getName();
                    String _firstUpper_7 = StringExtensions.toFirstUpper(_name_51);
                    _builder.append(_firstUpper_7, "		");
                  }
                }
                _builder.append("(session, ");
        ...
        _builder.newLineIfNotEmpty();
        {
          for(final Property toOneReference : toOneReferences) {
            ...
            String _firstUpper_8 = StringExtensions.toFirstUpper(_name_65);
            _builder.append(_firstUpper_8, "	");
            _builder.append("(");
            String _typeClassname = toOneReference.getTypeClassname();
            _builder.append(_typeClassname, "	");
            ...
            String _name_68 = toOneReference.getName();
        ...
        _builder.append("public int count");
        String _name_74 = entity_1.getName();
        String _firstUpper_10 = StringExtensions.toFirstUpper(_name_74);
        _builder.append(_firstUpper_10, "	");
        _builder.append("s() {");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
  ...
  public StringConcatenation generateEntityDAO(final String packageName, final Entity entity) {
    ...
    _builder.newLine();
    {
      for(final Property property_3 : uniqueProperties) {
        ...
        String _name_21 = property_3.getName();
        String _firstUpper = StringExtensions.toFirstUpper(_name_21);
        _builder.append(_firstUpper, "	");
        ...
        String _name_24 = property_3.getName();
        String _upperCase_1 = _name_24.toUpperCase();
    ...
    }
    {
      for(final Property property_4 : toOneProperties) {
        ...
        _builder.append("\t");
        _builder.append("criteria = criteria.add(Restrictions.eq(FIELD__");
        String _name_33 = property_4.getName();
          ...
          if ((constraint instanceof UniqueConstraint)) {
            ...
            _builder.append(" getBy");
            {
              ...
              for(final Property property_5 : _properties_5) {
                String _name_39 = property_5.getName();
    ...
    }
    {
      for(final Property property_8 : enumProperties) {
        ...
        _builder.append(_name_45, "	 ");
        _builder.append("s with the given ");
        String _name_46 = property_8.getName();
        _builder.append(_name_46, "	 ");
        _builder.append(".");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        ...
        _builder.append(_name_47, "	");
        _builder.append("> getBy");
        String _name_48 = property_8.getName();
        String _firstUpper_3 = StringExtensions.toFirstUpper(_name_48);
        _builder.append(_firstUpper_3, "	");
        _builder.append("(Session session, ");
        ...
        _builder.append("\t");
        _builder.append("criteria = criteria.add(Restrictions.eq(FIELD__");
        String _name_51 = property_8.getName();
        String _upperCase_4 = _name_51.toUpperCase();
      ...
      for(final Property property_9 : _properties_9) {
        {
          ...
          String _name_63 = java.lang.String.class.getName();
          boolean _equals = _javaClassname_5.equals(_name_63);
          if (_equals) {
            _builder.append("\t\t");
            _builder.append("disjunction.add(Restrictions.like(FIELD__");
            String _name_64 = property_9.getName();
            String _upperCase_5 = _name_64.toUpperCase();
    ...
    _builder.newLineIfNotEmpty();
    {
      for(final Property toOneReference : toOneReferences) {
        ...
        String _name_69 = toOneReference.getName();
        String _firstUpper_4 = StringExtensions.toFirstUpper(_name_69);
        _builder.append(_firstUpper_4, "	");
        ...
        _builder.append("\t");
        _builder.append("criteria = criteria.add(Restrictions.eq(FIELD__");
        String _name_72 = toOneReference.getName();
        String _upperCase_6 = _name_72.toUpperCase();
          ...
          for(final Property property_10 : _properties_11) {
            {
              ...
              String _name_74 = java.lang.String.class.getName();
              boolean _equals_1 = _javaClassname_6.equals(_name_74);
              if (_equals_1) {
                _builder.append("\t");
                _builder.append("\t");
                _builder.append("disjunction.add(Restrictions.like(FIELD__");
                String _name_75 = property_10.getName();
                String _upperCase_7 = _name_75.toUpperCase();
