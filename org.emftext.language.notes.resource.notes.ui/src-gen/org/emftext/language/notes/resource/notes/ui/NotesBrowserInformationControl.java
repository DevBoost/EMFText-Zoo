 ...
 * @since 3.2
 */
public class NotesBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.notes.resource.notes.ui.NotesDocBrowserInformationControlInput fInput;
	 ...
	 */
	public NotesBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public NotesBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public NotesBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.notes.resource.notes.ui.NotesDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.notes.resource.notes.ui.NotesDocBrowserInformationControlInput) input;
		...
		org.emftext.language.notes.resource.notes.ui.NotesHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.notes.resource.notes.ui.NotesHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.language.notes.resource.notes.ui.NotesDocBrowserInformationControlInput getInput() {
		return fInput;
	}
