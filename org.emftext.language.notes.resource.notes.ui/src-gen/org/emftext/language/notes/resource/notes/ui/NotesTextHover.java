 ...
 */
public class NotesTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.emftext.language.notes.resource.notes.INotesHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.notes.resource.notes.ui.NotesBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.notes.resource.notes.ui.NotesBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.notes.resource.notes.ui.NotesDocBrowserInformationControlInput infoInput = (org.emftext.language.notes.resource.notes.ui.NotesDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.notes.resource.notes.ui.NotesHyperlink hyperlink = new org.emftext.language.notes.resource.notes.ui.NotesHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.notes.resource.notes.ui.NotesBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.notes.resource.notes.ui.NotesBrowserInformationControl iControl = new org.emftext.language.notes.resource.notes.ui.NotesBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.notes.resource.notes.ui.NotesDocBrowserInformationControlInput) {
							org.emftext.language.notes.resource.notes.ui.NotesDocBrowserInformationControlInput input = (org.emftext.language.notes.resource.notes.ui.NotesDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.notes.resource.notes.ui.NotesBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.notes.resource.notes.ui.NotesBrowserInformationControl iControl = new org.emftext.language.notes.resource.notes.ui.NotesBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public NotesTextHover(org.emftext.language.notes.resource.notes.INotesResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.language.notes.resource.notes.ui.NotesUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.emftext.language.notes.resource.notes.ui.NotesDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.emftext.language.notes.resource.notes.ui.NotesDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.emftext.language.notes.resource.notes.ui.NotesDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.notes.resource.notes.ui.NotesDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.notes.resource.notes.ui.NotesHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.language.notes.resource.notes.ui.NotesHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.notes.resource.notes.ui.NotesHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.notes.resource.notes.ui.NotesTextHover.getStyleSheet());
			org.emftext.language.notes.resource.notes.ui.NotesHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.notes.resource.notes.ui.NotesDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.language.notes.resource.notes.ui.NotesHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.notes.resource.notes.ui.NotesUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.language.notes.resource.notes.util.NotesStreamUtil.getContent(styleSheetURL.openStream());
