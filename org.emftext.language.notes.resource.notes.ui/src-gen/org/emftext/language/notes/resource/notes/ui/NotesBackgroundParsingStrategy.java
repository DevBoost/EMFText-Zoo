 ...
 */
public class NotesBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.language.notes.resource.notes.INotesTextResource resource, final org.emftext.language.notes.resource.notes.ui.NotesEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.emftext.language.notes.resource.notes.INotesTextResource resource, final org.emftext.language.notes.resource.notes.ui.NotesEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.language.notes.resource.notes.INotesTextResource resource, final org.emftext.language.notes.resource.notes.ui.NotesEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
