 ...
 */
public class NotesNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public NotesNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new notes file");
