 ...
 * a specified depth.
 */
public class NotesOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public NotesOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.emftext.language.notes.resource.notes.util.NotesStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.language.notes.resource.notes.ui.NotesEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.language.notes.resource.notes.mopp.NotesPlugin.logError("Exception while refreshing outline view", e);
		}
	}
