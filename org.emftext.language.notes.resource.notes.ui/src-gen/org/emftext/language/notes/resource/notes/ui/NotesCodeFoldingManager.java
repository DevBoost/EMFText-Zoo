 ...
 */
public class NotesCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.notes.resource.notes.INotesBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.notes.resource.notes.ui.NotesEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.notes.resource.notes.ui.NotesEditor) {
				org.emftext.language.notes.resource.notes.ui.NotesEditor editor = (org.emftext.language.notes.resource.notes.ui.NotesEditor) workbenchPart;
	...
	protected org.emftext.language.notes.resource.notes.ui.NotesEditor editor;
	 ...
	 */
	public NotesCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.notes.resource.notes.ui.NotesEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.notes.resource.notes.ui.NotesEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.notes.resource.notes.ui.NotesUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.notes.resource.notes.INotesTextResource textResource = (org.emftext.language.notes.resource.notes.INotesTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
