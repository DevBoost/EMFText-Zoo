...
public class NotesMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.emftext.language.notes.resource.notes.INotesOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.emftext.language.notes.resource.notes.mopp.NotesResource) {
					org.emftext.language.notes.resource.notes.mopp.NotesResource customResource = (org.emftext.language.notes.resource.notes.mopp.NotesResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.emftext.language.notes.resource.notes.INotesQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.emftext.language.notes.resource.notes.INotesQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.emftext.language.notes.resource.notes.ui.NotesUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.emftext.language.notes.resource.notes.ui.NotesUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.emftext.language.notes.resource.notes.INotesQuickFix> getQuickFixes(org.emftext.language.notes.resource.notes.INotesTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.emftext.language.notes.resource.notes.INotesQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
