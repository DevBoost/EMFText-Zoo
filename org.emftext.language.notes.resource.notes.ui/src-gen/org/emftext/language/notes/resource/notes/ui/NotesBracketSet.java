...
public class NotesBracketSet {
	...
	private java.util.ArrayList<org.emftext.language.notes.resource.notes.INotesBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.language.notes.resource.notes.INotesBracketPair {
	 ...
	 */
	private class ClosingListener implements org.emftext.language.notes.resource.notes.ui.INotesBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.notes.resource.notes.INotesBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public NotesBracketSet(org.emftext.language.notes.resource.notes.ui.NotesEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.language.notes.resource.notes.mopp.NotesMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.notes.resource.notes.INotesBracketPair>();
	 ...
	 */
	public org.emftext.language.notes.resource.notes.INotesBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.notes.resource.notes.INotesBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.notes.resource.notes.INotesBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.language.notes.resource.notes.INotesBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.notes.resource.notes.ui.NotesPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.language.notes.resource.notes.INotesBracketPair remove(String opening, String closing) {
		for (org.emftext.language.notes.resource.notes.INotesBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.notes.resource.notes.INotesBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.notes.resource.notes.ui.NotesPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.notes.resource.notes.ui.NotesPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
