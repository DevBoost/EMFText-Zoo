...
public class NotesNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.emftext.language.notes.resource.notes.ui.NotesNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public NotesNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.emftext.language.notes.resource.notes.ui.NotesNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.emftext.language.notes.resource.notes.ui.NotesUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.emftext.language.notes.resource.notes.ui.NotesUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.emftext.language.notes.resource.notes.mopp.NotesMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new org.emftext.language.notes.resource.notes.mopp.NotesMetaInformation().getSyntaxName();
	}
