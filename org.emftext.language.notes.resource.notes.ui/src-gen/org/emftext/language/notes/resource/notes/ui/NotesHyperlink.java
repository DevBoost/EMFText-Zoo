 ...
 */
public class NotesHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public NotesHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.language.notes.resource.notes.mopp.NotesPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
