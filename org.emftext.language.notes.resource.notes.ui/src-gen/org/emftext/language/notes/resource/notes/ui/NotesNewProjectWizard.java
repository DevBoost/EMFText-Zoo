 ...
 */
public class NotesNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.emftext.language.notes.resource.notes.mopp.NotesMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.emftext.language.notes.resource.notes.ui");
							...
							String natureID = org.emftext.language.notes.resource.notes.mopp.NotesNature.NATURE_ID;
							...
							for (String builderID : org.emftext.language.notes.resource.notes.mopp.NotesNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.emftext.language.notes.resource.notes.mopp.NotesMetaInformation info = new org.emftext.language.notes.resource.notes.mopp.NotesMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.emftext.language.notes.resource.notes.ui.NotesUIPlugin.getDefault().getBundle();
