...
/**
 * A text editor for 'notes' models.
 */
public class NotesEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.emftext.language.notes.resource.notes.INotesResourceProvider, org.emftext.language.notes.resource.notes.ui.INotesBracketHandlerProvider, org.emftext.language.notes.resource.notes.ui.INotesAnnotationModelProvider {
	
	private org.emftext.language.notes.resource.notes.ui.NotesHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.notes.resource.notes.ui.NotesCodeFoldingManager codeFoldingManager;
	private org.emftext.language.notes.resource.notes.ui.NotesBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.notes.resource.notes.ui.NotesBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.notes.resource.notes.INotesBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.notes.resource.notes.INotesBackgroundParsingListener>();
	private org.emftext.language.notes.resource.notes.ui.NotesColorManager colorManager = new org.emftext.language.notes.resource.notes.ui.NotesColorManager();
	private org.emftext.language.notes.resource.notes.ui.NotesOutlinePage outlinePage;
	...
	private org.emftext.language.notes.resource.notes.ui.NotesPropertySheetPage propertySheetPage;
	...
	private org.emftext.language.notes.resource.notes.ui.INotesBracketHandler bracketHandler;
	...
	public NotesEditor() {
		super();
		setSourceViewerConfiguration(new org.emftext.language.notes.resource.notes.ui.NotesEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), NotesEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.notes.resource.notes.INotesTextResource currentResource = getResource();
				...
				org.emftext.language.notes.resource.notes.ui.NotesUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.language.notes.resource.notes.EditorContext");
		setRulerContextMenuId("org.emftext.language.notes.resource.notes.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.notes.resource.notes.ui.NotesHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.notes.resource.notes.ui.NotesCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.notes.resource.notes.mopp.NotesNature.activate(inputFile.getProject());
		...
		org.emftext.language.notes.resource.notes.INotesTextResource loadedResource = (org.emftext.language.notes.resource.notes.INotesTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.notes.resource.notes.INotesTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.notes.resource.notes.INotesTextResource) {
					setResource((org.emftext.language.notes.resource.notes.INotesTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.emftext.language.notes.resource.notes.ui.NotesUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the NotesEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.emftext.language.notes.resource.notes.ui.NotesUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.language.notes.resource.notes.INotesTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.notes.resource.notes.ui.NotesOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.notes.resource.notes.ui.NotesPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.notes.resource.notes.INotesTextResource textResource = (org.emftext.language.notes.resource.notes.INotesTextResource) element.eResource();
			org.emftext.language.notes.resource.notes.INotesLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.emftext.language.notes.resource.notes.INotesTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.notes.resource.notes.INotesTextToken token = lexer.getNextToken();
			...
			org.emftext.language.notes.resource.notes.ui.NotesUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!NotesEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.emftext.language.notes.resource.notes.INotesBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.notes.resource.notes.INotesBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.emftext.language.notes.resource.notes.ui.INotesBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.emftext.language.notes.resource.notes.ui.INotesBracketHandler bracketHandler) {
