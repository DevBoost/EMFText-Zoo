 ...
 */
public class NotesSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public NotesSyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.notes.resource.notes.INotesMetaInformation syntaxPlugin = new org.emftext.language.notes.resource.notes.mopp.NotesMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.notes.resource.notes.ui.NotesSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.notes.resource.notes.ui.NotesSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.notes.resource.notes.ui.NotesSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.notes.resource.notes.ui.NotesSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.notes.resource.notes.ui.NotesSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.notes.resource.notes.ui.NotesSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.notes.resource.notes.ui.NotesSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.notes.resource.notes.ui.NotesSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.notes.resource.notes.ui.NotesSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.notes.resource.notes.ui.NotesSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.notes.resource.notes.ui.NotesSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.notes.resource.notes.ui.NotesSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.notes.resource.notes.ui.NotesPixelConverter pixelConverter = new org.emftext.language.notes.resource.notes.ui.NotesPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.notes.resource.notes.ui.NotesEditor) {
			org.emftext.language.notes.resource.notes.ui.NotesEditor emfTextEditor = (org.emftext.language.notes.resource.notes.ui.NotesEditor) editor;
