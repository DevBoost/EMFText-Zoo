 ...
 * contains
 * <code>org.emftext.language.prolog.resource.pl.IPlTextDiagnostic</code>s it uses
...
public class PlMarkerHelper {
	 ...
	 */
	public static final String MARKER_TYPE = org.emftext.language.prolog.resource.pl.mopp.PlPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.emftext.language.prolog.resource.pl.IPlCommand<Object>> commands = new java.util.ArrayList<org.emftext.language.prolog.resource.pl.IPlCommand<Object>>();
		private final Object jobLock = new Object();
		
		public void addCommand(org.emftext.language.prolog.resource.pl.IPlCommand<Object> command) {
			...
			new org.eclipse.core.runtime.jobs.Job("updating markers") {
				...
				protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
					synchronized(jobLock) {
						java.util.List<org.emftext.language.prolog.resource.pl.IPlCommand<Object>> commandsToProcess = new java.util.ArrayList<org.emftext.language.prolog.resource.pl.IPlCommand<Object>>();
						synchronized(commands) {
							commandsToProcess.addAll(commands);
							commands.clear();
						}
						for (org.emftext.language.prolog.resource.pl.IPlCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public static void mark(org.eclipse.emf.ecore.resource.Resource resource, final org.emftext.language.prolog.resource.pl.IPlTextDiagnostic diagnostic) {
	...
	private static void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.emftext.language.prolog.resource.pl.IPlTextDiagnostic diagnostic) {
		final org.emftext.language.prolog.resource.pl.IPlProblem problem = diagnostic.getProblem();
		org.emftext.language.prolog.resource.pl.PlEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.emftext.language.prolog.resource.pl.IPlCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.emftext.language.prolog.resource.pl.PlEProblemSeverity.ERROR) {
					...
					org.emftext.language.prolog.resource.pl.IPlTextDiagnostic textDiagnostic = (org.emftext.language.prolog.resource.pl.IPlTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.emftext.language.prolog.resource.pl.mopp.PlResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.emftext.language.prolog.resource.pl.mopp.PlResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.emftext.language.prolog.resource.pl.IPlQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.emftext.language.prolog.resource.pl.util.PlStringUtil.explode(sourceIDs, "|"));
					}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.emftext.language.prolog.resource.pl.PlEProblemType nextType : org.emftext.language.prolog.resource.pl.PlEProblemType.values()) {
	 ...
	 */
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.language.prolog.resource.pl.PlEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.emftext.language.prolog.resource.pl.PlEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public static String getMarkerID(org.emftext.language.prolog.resource.pl.PlEProblemType problemType) {
	...
	private static void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.emftext.language.prolog.resource.pl.util.PlRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.emftext.language.prolog.resource.pl.IPlCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.emftext.language.prolog.resource.pl.mopp.PlPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
