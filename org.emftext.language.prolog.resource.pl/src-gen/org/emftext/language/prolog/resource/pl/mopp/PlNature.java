...
public class PlNature implements org.eclipse.core.resources.IProjectNature {
	...
	public static final String NATURE_ID = "org.emftext.language.prolog.resource.pl.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.emftext.language.prolog.resource.pl.mopp.PlBuilderAdapter.BUILDER_ID, org.emftext.language.prolog.resource.pl.mopp.PlTaskItemBuilder.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.emftext.language.prolog.resource.pl.mopp.PlBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
