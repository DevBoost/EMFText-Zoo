...
public class PlStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, org.emftext.language.prolog.resource.pl.IPlFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, org.emftext.language.prolog.resource.pl.IPlFunction1<String, T> toStringFunction) {
