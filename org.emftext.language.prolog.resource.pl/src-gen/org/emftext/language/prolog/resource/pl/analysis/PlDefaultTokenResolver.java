 ...
 */
public class PlDefaultTokenResolver implements org.emftext.language.prolog.resource.pl.IPlTokenResolver {
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.emftext.language.prolog.resource.pl.IPlTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.emftext.language.prolog.resource.pl.grammar.PlGrammarInformationProvider.INSTANCE.getKeywords()) {
