...
public interface IPlOptions {
	 ...
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new org.emftext.language.prolog.resource.pl.mopp.PlMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new org.emftext.language.prolog.resource.pl.mopp.PlMetaInformation().getResourcePostProcessorProviderOptionKey();
