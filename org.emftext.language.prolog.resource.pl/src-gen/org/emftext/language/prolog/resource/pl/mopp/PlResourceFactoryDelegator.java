...
public class PlResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	...
	protected void init() {
		...
		if (new org.emftext.language.prolog.resource.pl.util.PlRuntimeUtil().isEclipsePlatformAvailable()) {
			new org.emftext.language.prolog.resource.pl.util.PlEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new org.emftext.language.prolog.resource.pl.mopp.PlResourceFactory());
		}
	}
