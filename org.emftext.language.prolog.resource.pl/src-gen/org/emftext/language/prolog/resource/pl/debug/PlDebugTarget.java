...
public class PlDebugTarget extends org.emftext.language.prolog.resource.pl.debug.PlDebugElement implements org.eclipse.debug.core.model.IDebugTarget, org.emftext.language.prolog.resource.pl.debug.IPlDebugEventListener {
	
	/**
	 * associated system process
	 */
	private org.emftext.language.prolog.resource.pl.debug.PlDebugProcess process;
	...
	private org.emftext.language.prolog.resource.pl.debug.PlDebugThread thread;
	 ...
	 * event listeners
	 */
	private java.util.List<org.emftext.language.prolog.resource.pl.debug.IPlDebugEventListener> eventListeners = new java.util.ArrayList<org.emftext.language.prolog.resource.pl.debug.IPlDebugEventListener>();
	
	private org.emftext.language.prolog.resource.pl.debug.PlDebugProxy debugProxy;
	...
	private class DebugEventDispatcher extends org.eclipse.core.runtime.jobs.Job {
		...
		public DebugEventDispatcher() {
			super(new org.emftext.language.prolog.resource.pl.mopp.PlMetaInformation().getSyntaxName() + " Event Dispatch");
			setSystem(true);
		}
		
		protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
			while (!isTerminated()) {
				org.emftext.language.prolog.resource.pl.debug.PlDebugMessage message = communicationHelper.receive(eventReader);
				if (message != null) {
		...
		private void notifyListeners(org.emftext.language.prolog.resource.pl.debug.PlDebugMessage message) {
			Object[] listeners = eventListeners.toArray();
			for (int i = 0; i < listeners.length; i++) {
				((org.emftext.language.prolog.resource.pl.debug.IPlDebugEventListener) listeners[i]).handleMessage(message);
			}
		}
	}
	
	public PlDebugTarget(org.emftext.language.prolog.resource.pl.debug.PlDebugProcess process, org.eclipse.debug.core.ILaunch launch, int requestPort, int eventPort) {
		super(launch.getDebugTarget());
		this.process = process;
		this.launch = launch;
		this.thread = new org.emftext.language.prolog.resource.pl.debug.PlDebugThread(this);
		this.threads = new org.eclipse.debug.core.model.IThread[] {this.thread};
		
		// initialize debug proxy
		try {
			this.debugProxy = new org.emftext.language.prolog.resource.pl.debug.PlDebugProxy(this, requestPort);
	 ...
	 */
	public void addEventListener(org.emftext.language.prolog.resource.pl.debug.IPlDebugEventListener listener) {
	 ...
	 * @param listener event listener
	 */
	public void removeEventListener(org.emftext.language.prolog.resource.pl.debug.IPlDebugEventListener listener) {
		eventListeners.remove(listener);
	}
	
	public String getName() throws org.eclipse.debug.core.DebugException {
		return new org.emftext.language.prolog.resource.pl.mopp.PlMetaInformation().getSyntaxName() + " model";
	}
		...
		if (supportsBreakpoint(breakpoint)) {
			try {
				if ((breakpoint.isEnabled() && getBreakpointManager().isEnabled()) || !breakpoint.isRegistered()) {
					org.emftext.language.prolog.resource.pl.debug.PlLineBreakpoint lineBreakpoint = (org.emftext.language.prolog.resource.pl.debug.PlLineBreakpoint) breakpoint;
	...
	public void handleMessage(org.emftext.language.prolog.resource.pl.debug.PlDebugMessage message) {
		try {
			if (message.hasType(org.emftext.language.prolog.resource.pl.debug.EPlDebugMessageTypes.STARTED)) {
				started();
			} else if (message.hasType(org.emftext.language.prolog.resource.pl.debug.EPlDebugMessageTypes.SUSPENDED)) {
				suspend();
			} else if (message.hasType(org.emftext.language.prolog.resource.pl.debug.EPlDebugMessageTypes.TERMINATED)) {
				terminated();
			} else if (message.hasType(org.emftext.language.prolog.resource.pl.debug.EPlDebugMessageTypes.RESUMED)) {
	...
	public org.emftext.language.prolog.resource.pl.debug.PlDebugProxy getDebugProxy() {
