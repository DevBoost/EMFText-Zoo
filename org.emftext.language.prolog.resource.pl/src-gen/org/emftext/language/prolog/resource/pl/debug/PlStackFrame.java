...
public class PlStackFrame extends org.emftext.language.prolog.resource.pl.debug.PlDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.emftext.language.prolog.resource.pl.debug.PlDebugTarget target;
	private String name;
	private int id;
	...
	public PlStackFrame(org.emftext.language.prolog.resource.pl.debug.PlDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.emftext.language.prolog.resource.pl.util.PlStringUtil.decode(data, ',');
	...
	private org.emftext.language.prolog.resource.pl.debug.PlDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.emftext.language.prolog.resource.pl.debug.PlStackFrame other = (org.emftext.language.prolog.resource.pl.debug.PlStackFrame) obj;
		if (name == null) {
