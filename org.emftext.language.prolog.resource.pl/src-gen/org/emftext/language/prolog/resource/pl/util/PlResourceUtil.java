...
public class PlResourceUtil {
	...
	public static org.emftext.language.prolog.resource.pl.mopp.PlResource getResource(java.io.File file) {
	...
	public static org.emftext.language.prolog.resource.pl.mopp.PlResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.emftext.language.prolog.resource.pl.mopp.PlMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.emftext.language.prolog.resource.pl.mopp.PlResource) resource;
	}
	 ...
	 */
	public static org.emftext.language.prolog.PrologProgram getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.emftext.language.prolog.PrologProgram getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.emftext.language.prolog.PrologProgram) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static org.emftext.language.prolog.PrologProgram getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		org.emftext.language.prolog.resource.pl.IPlTextResource resource = (org.emftext.language.prolog.resource.pl.IPlTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (org.emftext.language.prolog.resource.pl.IPlTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		org.emftext.language.prolog.resource.pl.IPlTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
