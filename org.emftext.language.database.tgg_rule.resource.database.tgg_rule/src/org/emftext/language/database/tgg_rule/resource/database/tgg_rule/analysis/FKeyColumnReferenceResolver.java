...
public class FKeyColumnReferenceResolver implements org.emftext.language.database.tgg_rule.resource.database.tgg_rule.IDatabase_tgg_ruleReferenceResolver<org.emftext.language.database.FKey, org.emftext.language.database.Column> {
	
	private org.emftext.language.database.resource.database.analysis.FKeyColumnReferenceResolver delegate = new org.emftext.language.database.resource.database.analysis.FKeyColumnReferenceResolver();
